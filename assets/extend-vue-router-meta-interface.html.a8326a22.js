import{r as t,c as o,a as s,b as p,F as c,e as a,d as n,o as r}from"./app.f0b2ea56.js";import{_ as l}from"./plugin-vue_export-helper.5a098b48.js";const u={},i=a(`<h1 id="\u6269\u5C55-vue-router-meta-\u4FE1\u606F" tabindex="-1"><a class="header-anchor" href="#\u6269\u5C55-vue-router-meta-\u4FE1\u606F" aria-hidden="true">#</a> \u6269\u5C55 Vue Router Meta \u4FE1\u606F</h1><p>\u5728\u5B9E\u9645\u5E94\u7528\u4E2D\u4F1A\u5728 <code>meta</code> \u6DFB\u52A0\u4E00\u4E9B\u5B57\u6BB5\uFF0C\u65B9\u4FBF\u505A\u8DEF\u7531\u4E0A\u7684\u529F\u80FD\u6269\u5C55\u3002\u800C TypeScript \u4E2D\u8981\u6DFB\u52A0\u5BF9\u5E94\u7684\u7C7B\u578B\u63D0\u793A\u9996\u5148\u60F3\u5230\u5BF9 <code>RouteRecordRaw</code> \u505A\u6269\u5C55\uFF1A</p><div class="language-typescript ext-ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">MenuMeta</span> <span class="token punctuation">{</span>
...
<span class="token keyword">declare</span> <span class="token keyword">module</span> <span class="token string">&#39;vue-router&#39;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,1);function g(b,f){const e=t("OutboundLink");return r(),o(c,null,[i,s("p",null,[k,s("a",d,[m,p(e)]),_]),h],64)}var v=l(u,[["render",g]]);export{v as default};
