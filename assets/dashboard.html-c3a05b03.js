import{_ as a,p as n,q as s,a1 as e}from"./framework-49860b1b.js";const t={},p=e(`<h1 id="kubernetes-dashboard" tabindex="-1"><a class="header-anchor" href="#kubernetes-dashboard" aria-hidden="true">#</a> Kubernetes Dashboard</h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><p>Kubernetes 默认没有部署 Dashboard，不过安装也很简单：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>kubectl apply <span class="token parameter variable">-f</span> https://raw.githubusercontent.com/kubernetes/dashboard/v2.0.0/aio/deploy/recommended.yaml
...
</code></pre></div><p>接着就可以登录了。</p>`,16),o=[p];function c(r,l){return n(),s("div",null,o)}const k=a(t,[["render",c],["__file","dashboard.html.vue"]]);export{k as default};
