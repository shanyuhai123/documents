import{_ as n,p as s,q as a,a1 as p}from"./framework-49860b1b.js";const t={},o=p(`<h1 id="快乐数" tabindex="-1"><a class="header-anchor" href="#快乐数" aria-hidden="true">#</a> 快乐数</h1><p>寻找其终结条件。</p><h2 id="哈希表" tabindex="-1"><a class="header-anchor" href="#哈希表" aria-hidden="true">#</a> 哈希表</h2><p>数字重复时自然就可以结束了。</p><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">isHappy</span><span class="token punctuation">(</span>n<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">)</span><span class="token operator">:</span> <span class="token builtin">boolean</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,8),e=[o];function c(l,u){return s(),a("div",null,e)}const r=n(t,[["render",c],["__file","202-happy-number.html.vue"]]);export{r as default};
