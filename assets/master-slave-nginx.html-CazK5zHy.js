import{_ as p,c as l,a,b as t,d as s,e as c,f as i,r as o,o as r}from"./app-DNXRdI82.js";const k={};function d(u,n){const e=o("RouteLink");return r(),l("div",null,[n[3]||(n[3]=a('<h1 id="主从-nginx" tabindex="-1"><a class="header-anchor" href="#主从-nginx"><span>主从 Nginx</span></a></h1><h2 id="准备" tabindex="-1"><a class="header-anchor" href="#准备"><span>准备</span></a></h2><table><thead><tr><th>name</th><th>ip</th><th>role</th></tr></thead><tbody><tr><td>web01</td><td>10.0.0.133</td><td>MASTER</td></tr><tr><td>web02</td><td>10.0.0.134</td><td>BACKUP</td></tr></tbody></table>',3)),t("p",null,[n[1]||(n[1]=s("为虚拟机")),c(e,{to:"/backend/nginx/install-nginx.html#%E7%BC%96%E8%AF%91%E5%AE%89%E8%A3%85"},{default:i(()=>n[0]||(n[0]=[s("安装")])),_:1}),n[2]||(n[2]=s("好 Nginx 和 keepalived。"))]),n[4]||(n[4]=a(`<p>修改 Nginx 的主页便于之后识别：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">vim</span> /usr/local/nginx/html/index.html</span>
