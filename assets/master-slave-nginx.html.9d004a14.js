import{r as e,c as t,a as p,b as c,w as o,F as l,e as a,d as n,o as r}from"./app.5799edae.js";import{_ as i}from"./plugin-vue_export-helper.5a098b48.js";const u={},d=a('<h1 id="\u4E3B\u4ECE-nginx" tabindex="-1"><a class="header-anchor" href="#\u4E3B\u4ECE-nginx" aria-hidden="true">#</a> \u4E3B\u4ECE Nginx</h1><h2 id="\u51C6\u5907" tabindex="-1"><a class="header-anchor" href="#\u51C6\u5907" aria-hidden="true">#</a> \u51C6\u5907</h2><table><thead><tr><th>name</th><th>ip</th><th>role</th></tr></thead><tbody><tr><td>web01</td><td>10.0.0.133</td><td>MASTER</td></tr><tr><td>web02</td><td>10.0.0.134</td><td>BACKUP</td></tr></tbody></table>',3),k=n("\u4E3A\u865A\u62DF\u673A"),h=n("\u5B89\u88C5"),m=n("\u597D Nginx \u548C keepalived\u3002"),f=a(`<p>\u4FEE\u6539 Nginx \u7684\u4E3B\u9875\u4FBF\u4E8E\u4E4B\u540E\u8BC6\u522B\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">vim</span> /usr/local/nginx/html/index.html
...
<span class="token comment"># &lt;h1&gt;Welcome to nginx2!&lt;/h1&gt;</span>
</code></pre></div>`,18);function b(_,v){const s=e("RouterLink");return r(),t(l,null,[d,p("p",null,[k,c(s,{to:"/backend/nginx/install-nginx.html#%E7%BC%96%E8%AF%91%E5%AE%89%E8%A3%85"},{default:o(()=>[h]),_:1}),m]),f],64)}var w=i(u,[["render",b]]);export{w as default};
