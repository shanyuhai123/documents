import{_ as n,p as s,q as a,a1 as t}from"./framework-49860b1b.js";const p={},o=t(`<h1 id="反转字符串中的单词-iii" tabindex="-1"><a class="header-anchor" href="#反转字符串中的单词-iii" aria-hidden="true">#</a> 反转字符串中的单词 III</h1><p>需要先确认单词位置。</p><h2 id="遍历" tabindex="-1"><a class="header-anchor" href="#遍历" aria-hidden="true">#</a> 遍历</h2><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">reverseWords</span><span class="token punctuation">(</span>s<span class="token operator">:</span> <span class="token builtin">string</span><span class="token punctuation">)</span><span class="token operator">:</span> <span class="token builtin">string</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,4),e=[o];function c(r,l){return s(),a("div",null,e)}const u=n(p,[["render",c],["__file","557-reverse-words-in-a-string-iii.html.vue"]]);export{u as default};
