import{_ as n,c as a,a as e,o as p}from"./app-CQrWi6O2.js";const t={};function o(l,s){return p(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="扩展-vue-router-meta-信息" tabindex="-1"><a class="header-anchor" href="#扩展-vue-router-meta-信息"><span>扩展 Vue Router Meta 信息</span></a></h1><p>在实际应用中会在 <code>meta</code> 添加一些字段，方便做路由上的功能扩展。而 TypeScript 中要添加对应的类型提示首先想到对 <code>RouteRecordRaw</code> 做扩展：</p><div class="language-typescript" data-highlighter="prismjs" data-ext="ts" data-title="ts"><pre><code><span class="line"><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">MenuMeta</span> <span class="token punctuation">{</span></span>
...
<span class="line">  <span class="token punctuation">}</span></span>
<span class="line"><span class="token punctuation">}</span></span>
<span class="line"></span></code></pre></div>`,5)])])}const r=n(t,[["render",o]]),i=JSON.parse('{"path":"/frontend/typescript/extend-vue-router-meta-interface.html","title":"扩展 Vue Router Meta 信息","lang":"zh-CN","frontmatter":{},"headers":[],"git":{"updatedTime":1637398040000,"contributors":[{"name":"shanyuhai123","username":"shanyuhai123","email":"864299347@qq.com","commits":2,"url":"https://github.com/shanyuhai123"}]},"filePathRelative":"frontend/typescript/extend-vue-router-meta-interface.md"}');export{r as comp,i as data};
