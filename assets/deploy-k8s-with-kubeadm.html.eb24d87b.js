import{r as o,c,a,b as t,F as l,e as s,d as e,o as r}from"./app.cc89d5d0.js";import{_ as d}from"./plugin-vue_export-helper.5a098b48.js";const p={},i=s(`<h2 id="\u524D\u8A00" tabindex="-1"><a class="header-anchor" href="#\u524D\u8A00" aria-hidden="true">#</a> \u524D\u8A00</h2><p>\u867D\u7136 kubeadm \u5C4F\u853D\u4E86\u7EC6\u8282\uFF0C\u9047\u5230\u95EE\u9898\u96BE\u4EE5\u6392\u67E5\uFF0C\u4F46\u662F\u5B83\u7B80\u5355\u5FEB\u6377\u3002</p><p>\u89C4\u5212\u4E3A\u5355 master \u4E09 node \u7684\u96C6\u7FA4\uFF0C\u5E76\u5728 master \u4E2D\u8BBE\u7F6E hosts\u3002</p><div class="language-text ext-text"><pre class="language-text"><code>hostnamectl set-hostname k8s-master
...
kubectl get pod,svc
</code></pre></div>`,15);function w(S,N){const n=o("OutboundLink");return r(),c(l,null,[i,a("p",null,[u,a("a",h,[k,t(n)]),b]),g,a("p",null,[m,a("a",f,[_,t(n)]),v,x,y,E,O]),F],64)}var T=d(p,[["render",w]]);export{T as default};
