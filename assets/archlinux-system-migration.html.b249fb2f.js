...
</code></pre></div>`,25),v=s("\u82E5\u540E\u7EED\u542F\u7528 "),_={href:"https://wiki.archlinux.org/title/Swap_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)",target:"_blank",rel:"noopener noreferrer"},x=s("swap"),L=s("\uFF0C\u5219\u518D\u6267\u884C "),q=n("code",null,"genfstab",-1),G=s(" \u5373\u53EF\u3002"),y=t(`<h3 id="_2-\u5B89\u88C5\u4F9D\u8D56" tabindex="-1"><a class="header-anchor" href="#_2-\u5B89\u88C5\u4F9D\u8D56" aria-hidden="true">#</a> 2. \u5B89\u88C5\u4F9D\u8D56</h3><p>\u8FDB\u5165\u7CFB\u7EDF\u5E76\u5B89\u88C5\u4F9D\u8D56\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>arch-chroot /mnt
...
</code></pre></div>`,5);function B(w,A){const a=p("OutboundLink");return l(),o(c,null,[r,d,k,n("p",null,[h,n("a",m,[b,e(a)]),g]),f,n("p",null,[v,n("a",_,[x,e(a)]),L,q,G]),y],64)}var S=u(i,[["render",B]]);export{S as default};
