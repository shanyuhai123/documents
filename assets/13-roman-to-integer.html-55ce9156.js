...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="更暴力的映射" tabindex="-1"><a class="header-anchor" href="#更暴力的映射" aria-hidden="true">#</a> 更暴力的映射</h2>`,5),k={href:"https://leetcode.com/problems/roman-to-integer/discuss/1191442/Functional-Typescript-Solution",target:"_blank",rel:"noopener noreferrer"},i=a(`<div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">const</span> romanNumeralMap <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,1);function m(d,g){const p=o("ExternalLinkIcon");return e(),c("div",null,[u,s("p",null,[n("这部分来源于 "),s("a",k,[n("Functional Typescript Solution"),l(p)]),n("：")]),i])}const h=t(r,[["render",m],["__file","13-roman-to-integer.html.vue"]]);export{h as default};
