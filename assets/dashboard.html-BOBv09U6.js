import{_ as s,c as n,a as e,o as p}from"./app-DLCc4AGN.js";const t={};function l(o,a){return p(),n("div",null,[...a[0]||(a[0]=[e(`<h1 id="kubernetes-dashboard" tabindex="-1"><a class="header-anchor" href="#kubernetes-dashboard"><span>Kubernetes Dashboard</span></a></h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h2><p>Kubernetes 默认没有部署 Dashboard，不过安装也很简单：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">kubectl apply <span class="token parameter variable">-f</span> https://raw.githubusercontent.com/kubernetes/dashboard/v2.0.0/aio/deploy/recommended.yaml</span>
