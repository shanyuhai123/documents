...
</code></pre></div>`,14),d={href:"https://askubuntu.com/questions/765584/is-it-possible-to-use-broadcom-bcm43142-wifi-in-ubuntu-16-04",target:"_blank",rel:"noopener noreferrer"},u=a(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt-get</span> update
...
</code></pre></div>`,7);function k(b,h){const e=o("ExternalLinkIcon");return p(),c("div",null,[i,n("p",null,[n("a",d,[s("解决方案"),l(e)]),s("：")]),u])}const f=t(r,[["render",k],["__file","config-netplan.html.vue"]]);export{f as default};
