...
</code></pre></div><h2 id="测试" tabindex="-1"><a class="header-anchor" href="#测试" aria-hidden="true">#</a> 测试</h2><p>最后通过浏览器访问 <code>sub1.frp.xxx.com</code> 即可展现效果。</p>`,15);function d(h,x){const s=t("ExternalLinkIcon");return p(),o("div",null,[i,a("p",null,[n("虽然在 "),a("a",u,[n("FRP"),c(s)]),n(" 官网中给了 web 服务配置的示例，但在实际使用中存在两个问题：")]),k])}const _=e(r,[["render",d],["__file","frp-and-nginx-share-80-port.html.vue"]]);export{_ as default};
