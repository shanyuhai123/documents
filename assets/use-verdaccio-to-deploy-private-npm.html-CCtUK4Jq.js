import{_ as n,c as a,a as e,o as p}from"./app-DNXRdI82.js";const t={};function l(c,s){return p(),a("div",null,s[0]||(s[0]=[e(`<h1 id="使用-verdaccio-搭建私有-npm" tabindex="-1"><a class="header-anchor" href="#使用-verdaccio-搭建私有-npm"><span>使用 verdaccio 搭建私有 npm</span></a></h1><p>搭建私有 NPM 的方案有几个，此处选取 <a href="https://verdaccio.org/zh-CN/" target="_blank" rel="noopener noreferrer">Verdaccio</a>。</p><h2 id="尝试" tabindex="-1"><a class="header-anchor" href="#尝试"><span>尝试</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 全局安装</span></span>
