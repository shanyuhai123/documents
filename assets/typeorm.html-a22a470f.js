import{_ as o,M as e,p as c,q as l,Q as s,t as n,N as t,a1 as p}from"./framework-49860b1b.js";const u={},k=s("h1",{id:"typeorm",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#typeorm","aria-hidden":"true"},"#"),n(" TypeORM")],-1),r=s("h2",{id:"介绍",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#介绍","aria-hidden":"true"},"#"),n(" 介绍")],-1),i={href:"https://typeorm.io/",target:"_blank",rel:"noopener noreferrer"},d={href:"https://en.wikipedia.org/wiki/Object-relational_mapping",target:"_blank",rel:"noopener noreferrer"},m=p(`<p>可简单理解为：</p><div class="language-text" data-ext="text"><pre class="language-text"><code>数据库的表（table） --&gt; 类（class）
...
</code></pre></div>`,93),y={href:"https://typeorm.io/#/tree-entities/%E4%BD%BF%E7%94%A8%E6%A0%91%E5%AE%9E%E4%BD%93",target:"_blank",rel:"noopener noreferrer"},h=p('<h2 id="关系" tabindex="-1"><a class="header-anchor" href="#关系" aria-hidden="true">#</a> 关系</h2><p>关系可以帮助你轻松地与相关实体合作。</p><h3 id="joincolumn-jointable" tabindex="-1"><a class="header-anchor" href="#joincolumn-jointable" aria-hidden="true">#</a> JoinColumn &amp; JoinTable</h3><p><code>@JoinColumn</code> 不仅定义了关系的哪一侧包含带有外键的连接列，还允许自定义连接列名和引用的列名。</p><p>当我们设置 <code>@JoinColumn</code> 时，它会自动在数据库中创建一个名为 <code>propertyName + referenceColumnName</code> 的列。</p><p><code>@JoinTable</code> 用于 “多对多” 关系，联结表是由 TypeORM 自动创建的一个特殊的单独表。</p><h3 id="多对一和一对多" tabindex="-1"><a class="header-anchor" href="#多对一和一对多" aria-hidden="true">#</a> 多对一和一对多</h3><p>可以在 <code>@ManyToOne</code> / <code>@OneToMany</code> 关系中省略 <code>@JoinColumn</code>，除非需要自定义关联列在数据库中的名称。</p><p><code>@ManyToOne</code> 可以单独使用，但 <code>@OneToMany</code> 必须搭配 <code>@ManyToOne</code> 使用。</p><p>在设置 <code>@ManyToOne</code> 的地方，相关实体将会有 “关联 id” 和外键。</p>',10);function g(f,w){const a=e("ExternalLinkIcon");return c(),l("div",null,[k,r,s("p",null,[s("a",i,[n("TypeORM"),t(a)]),n(" 是一个 "),s("a",d,[n("ORM"),t(a)]),n(" 框架。")]),m,s("p",null,[n("更多查询参考 "),s("a",y,[n("使用树实体"),t(a)]),n("。")]),h])}const x=o(u,[["render",g],["__file","typeorm.html.vue"]]);export{x as default};
