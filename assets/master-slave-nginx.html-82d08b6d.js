import{_ as t,M as p,p as o,q as c,a1 as s,R as l,t as a,N as r,V as i}from"./framework-e3e34937.js";const k={};function u(d,n){const e=p("RouterLink");return o(),c("div",null,[n[3]||(n[3]=s('<h1 id="主从-nginx" tabindex="-1"><a class="header-anchor" href="#主从-nginx" aria-hidden="true">#</a> 主从 Nginx</h1><h2 id="准备" tabindex="-1"><a class="header-anchor" href="#准备" aria-hidden="true">#</a> 准备</h2><table><thead><tr><th>name</th><th>ip</th><th>role</th></tr></thead><tbody><tr><td>web01</td><td>10.0.0.133</td><td>MASTER</td></tr><tr><td>web02</td><td>10.0.0.134</td><td>BACKUP</td></tr></tbody></table>',3)),l("p",null,[n[1]||(n[1]=a("为虚拟机")),r(e,{to:"/backend/nginx/install-nginx.html#%E7%BC%96%E8%AF%91%E5%AE%89%E8%A3%85"},{default:i(()=>n[0]||(n[0]=[a("安装")])),_:1}),n[2]||(n[2]=a("好 Nginx 和 keepalived。"))]),n[4]||(n[4]=s(`<p>修改 Nginx 的主页便于之后识别：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /usr/local/nginx/html/index.html
...
<span class="token comment"># &lt;h1&gt;Welcome to nginx2!&lt;/h1&gt;</span>
</code></pre></div>`,18))])}const f=t(k,[["render",u],["__file","master-slave-nginx.html.vue"]]);export{f as default};
