import{_ as p,M as o,p as c,q as l,Q as a,t as n,N as t,a1 as s}from"./framework-49860b1b.js";const u={},r=s('<h1 id="docker-compose-管理多个服务" tabindex="-1"><a class="header-anchor" href="#docker-compose-管理多个服务" aria-hidden="true">#</a> Docker Compose 管理多个服务</h1><h2 id="为什么需要-docker-compose" tabindex="-1"><a class="header-anchor" href="#为什么需要-docker-compose" aria-hidden="true">#</a> 为什么需要 Docker Compose</h2><p>先简单理解 Docker 的使用过程：</p><ol><li>镜像构建：即创建一个镜像，这个创建的过程就是用 <code>Dockerfile</code> 来完成的。</li><li>容器启动：针对单个容器可以使用 <code>docker run</code> 来启动，那多个呢？于是就出现了 Docker Compose。</li></ol><h3 id="_1-说明" tabindex="-1"><a class="header-anchor" href="#_1-说明" aria-hidden="true">#</a> 1. 说明</h3><p>Docker Compose 中定义的每个服务都必须通过 <code>image</code> 或 <code>build</code> 指令来构建，<code>build</code> 时会应用 <code>Dockerfile</code> 中的配置，无需重复设置。</p><h3 id="_2-默认" tabindex="-1"><a class="header-anchor" href="#_2-默认" aria-hidden="true">#</a> 2. 默认</h3><p>默认模板文件为 <code>docker-compose.yml</code>，默认的项目名称为所在目录名。</p><h2 id="安装卸载" tabindex="-1"><a class="header-anchor" href="#安装卸载" aria-hidden="true">#</a> 安装卸载</h2>',9),i={href:"https://github.com/docker/compose/releases",target:"_blank",rel:"noopener noreferrer"},k=s(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 下载</span>
...
</code></pre></div>`,46);function y(g,v){const e=o("ExternalLinkIcon");return c(),l("div",null,[r,a("p",null,[n("选择二进制安装的形式，更多版本可见 "),a("a",i,[n("github release"),t(e)]),n("。")]),k,a("p",null,[d,n(" 与 Docker Engine 是强关联的，"),a("a",h,[n("Reference"),t(e)]),n(" 中有详细对照关系。")]),m])}const b=p(u,[["render",y],["__file","docker-compose.html.vue"]]);export{b as default};
