...
<span class="token punctuation">}</span>
</code></pre></div>`,4),q={id:"_2-hash-\u7B97\u6CD5",tabindex:"-1"},B=s("a",{class:"header-anchor",href:"#_2-hash-\u7B97\u6CD5","aria-hidden":"true"},"#",-1),O=n(" 2. "),L={href:"https://nginx.org/en/docs/http/ngx_http_upstream_module.html#hash",target:"_blank",rel:"noopener noreferrer"},V=n("hash"),C=n(" \u7B97\u6CD5"),H=e(`<p>\u76F8\u5BF9\u4E8E <code>ip_hash</code> \u4E0D\u518D\u5C40\u9650\u4E8E <code>$remote_addr</code>\uFF0C\u53EF\u4EE5\u6307\u5B9A\u5173\u952E\u5B57\uFF08\u5176\u4F59\u7684\u53D8\u91CF\u751A\u81F3\u5B57\u7B26\u4E32\uFF09\u6765\u5F62\u6210 hash\u3002</p><blockquote><p>\u5728\u4E4B\u524D\u4E86\u89E3\u5230 <code>split_client</code> \u53EF\u4EE5\u7528\u4E8E\u5904\u7406 AB \u6D4B\u8BD5\uFF0C\u4F46\u662F\u7591\u60D1\u7684\u662F\u65E0\u6CD5\u6307\u5B9A\u67D0\u4E00\u6279\u7528\u6237\uFF0C\u90A3\u4E48\u914D\u5408\u4E0A hash \u7B97\u6CD5\u80FD\u5426\u5B9E\u73B0\u66F4\u597D\u7684 AB \u6D4B\u8BD5\u5462\u3002</p></blockquote><div class="language-nginx ext-nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">Syntax:</span> hash key [consistent]</span><span class="token punctuation">;</span>
...
</code></pre></div><h2 id="upstream-module-directives" tabindex="-1"><a class="header-anchor" href="#upstream-module-directives" aria-hidden="true">#</a> upstream module directives</h2>`,4),K={id:"_1-proxy-pass",tabindex:"-1"},S=s("a",{class:"header-anchor",href:"#_1-proxy-pass","aria-hidden":"true"},"#",-1),j=n(" 1. "),A={href:"https://nginx.org/en/docs/http/ngx_http_proxy_module.html#proxy_pass",target:"_blank",rel:"noopener noreferrer"},F=n("proxy_pass"),D=e("<p><code>proxy_pass</code> \u53EF\u4EE5\u8BBE\u7F6E\u4EE3\u7406\u670D\u52A1\u5668\u7684\u534F\u8BAE\u548C\u5730\u5740\uFF0C\u4EE5\u53CA\u5E94\u5C06\u4F4D\u7F6E\u6620\u5C04\u5230\u7684\u53EF\u9009\u7684 URI\u3002</p><p>\u9700\u8981\u6CE8\u610F\u7684\u662F <code>proxy_pass</code> \u5FC5\u987B\u4EE5 <code>http://</code> \u6216 <code>https://</code> \u5F00\u5934\u3002</p><p>URI \u4F1A\u5BFC\u81F4\u7C7B\u4F3C alias \u7684\u6548\u679C\uFF0C\u4E0D\u518D\u662F\u5B8C\u6574\u8F6C\u53D1\u4E86\u3002\u6240\u4EE5\u4E0D\u643A\u5E26 URI\uFF0C\u5219\u5C06\u8BF7\u6C42 URI \u4EE5\u539F\u59CB\u8BF7\u6C42\u5904\u7406\u65F6\u5BA2\u6237\u7AEF\u53D1\u9001\u7684\u683C\u5F0F\u4F20\u9012\u5230\u670D\u52A1\u5668\uFF1B\u643A\u5E26 URI \u5219\u4F1A\u5BFC\u81F4\u539F\u59CB\u8BF7\u6C42URI \u7684\u4E00\u90E8\u5206\u5C06\u88AB <code>proxy_pass</code> \u4E2D\u6307\u5B9A\u7684 URI \u4EE3\u66FF\u3002</p>",3);function E($,z){const t=o("OutboundLink"),p=o("RouterLink");return l(),c(i,null,[h,s("p",null,[k,s("a",_,[m,a(t)]),g]),x,s("p",null,[b,a(p,{to:"/backend/nginx/nginx-directives.html#alias"},{default:r(()=>[v]),_:1}),f]),y,s("h3",w,[I,R,s("a",N,[U,a(t)]),P]),T,s("h3",q,[B,O,s("a",L,[V,a(t)]),C]),H,s("h3",K,[S,j,s("a",A,[F,a(t)])]),D],64)}var M=d(u,[["render",E]]);export{M as default};
