...
</code></pre></div></li><li><p>push 项目</p><p>因为在一开始 clone 的时候已经配置好了，所以 push 时就无需配置了。不过我们还需要 <code>git config</code> 修改一下本地的 <code>user.name</code> 和 <code>user.email</code> 来保证是同一个人修改了, 否则会应用全局的 <code>config</code> 设置</p></li></ol>`,5),o=[i];function l(d,h){return s(),a("div",null,o)}const r=e(c,[["render",l],["__file","switch-multiple-github-accounts.html.vue"]]);export{r as default};
