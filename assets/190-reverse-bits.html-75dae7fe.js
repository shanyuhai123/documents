import{_ as s,p as a,q as t,a1 as p}from"./framework-e3e34937.js";const e={};function o(c,n){return a(),t("div",null,n[0]||(n[0]=[p(`<h1 id="颠倒二进制位" tabindex="-1"><a class="header-anchor" href="#颠倒二进制位" aria-hidden="true">#</a> 颠倒二进制位</h1><p>抄。</p><h2 id="逐位颠倒" tabindex="-1"><a class="header-anchor" href="#逐位颠倒" aria-hidden="true">#</a> 逐位颠倒</h2><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">reverseBits</span><span class="token punctuation">(</span>n<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">)</span><span class="token operator">:</span> <span class="token builtin">number</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,4)]))}const l=s(e,[["render",o],["__file","190-reverse-bits.html.vue"]]);export{l as default};
