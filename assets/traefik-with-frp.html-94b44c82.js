...
</code></pre></div>`,12),i={href:"https://docs.shanyuhai.top/backend/traefik/quick-start.html#%E6%9C%80%E7%BB%88%E9%85%8D%E7%BD%AE",target:"_blank",rel:"noopener noreferrer"},k=e(`<div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3.7&#39;</span>
...
</code></pre></div><p>登录到你的 DNS 帐号，创建一条 CNAME 记录 <code>_acme-challenge.frp</code> 指向 <code>187gf679-4961-4ave-a211-bc77ead16918.auth.acme-dns.io</code>，再次执行 <code>docker-compose up</code>。</p><p>稍后可在 <code>acme.json</code> 文件中找到对应的记录，即证书签发成功。</p><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>`,6),d={href:"https://soulteary.com/2020/10/04/frp-in-docker.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://hexo.aufomm.com/2020/04/06/Traefik-2-Request-Multiple-domain-and-Wildcard-SSL-certificates/",target:"_blank",rel:"noopener noreferrer"};function f(h,q){const s=o("ExternalLinkIcon");return c(),u("div",null,[l,n("p",null,[a("在 "),n("a",i,[a("最终配置"),t(s)]),a(" 上增加：")]),k,n("ul",null,[n("li",null,[n("a",d,[a("容器化 FRP 使用方案"),t(s)])]),n("li",null,[n("a",m,[a("Traefik 2 Request Multiple domain and Wildcard SSL certificates"),t(s)])])])])}const g=p(r,[["render",f],["__file","traefik-with-frp.html.vue"]]);export{g as default};
