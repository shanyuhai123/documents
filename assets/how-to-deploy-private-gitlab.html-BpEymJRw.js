import{_ as s,c as n,a as e,o as p}from"./app-DLCc4AGN.js";const t={};function l(c,a){return p(),n("div",null,[...a[0]||(a[0]=[e(`<h1 id="如何搭建私有-gitlab" tabindex="-1"><a class="header-anchor" href="#如何搭建私有-gitlab"><span>如何搭建私有 GitLab</span></a></h1><h2 id="安装-gitlab" tabindex="-1"><a class="header-anchor" href="#安装-gitlab"><span>安装 GitLab</span></a></h2><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 创建数据目录</span></span>
