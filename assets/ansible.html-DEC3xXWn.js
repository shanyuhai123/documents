import{_ as o,c,b as a,a as l,d as n,e as p,w as t,r as i,o as r}from"./app-DLCc4AGN.js";const u={};function m(k,s){const e=i("RouteLink");return r(),c("div",null,[s[7]||(s[7]=a("h1",{id:"分发脚本-ansible",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#分发脚本-ansible"},[a("span",null,"分发脚本 ansible")])],-1)),s[8]||(s[8]=a("p",null,"虽然也可以自己写 Shell 实现分发脚本，但由于缺乏运维系统概念，混乱、零碎的写法总是让人难受，一接触到 ansible 就知道很难回去了。",-1)),a("p",null,[s[1]||(s[1]=n("Ansible 是一个用来批量管理部署远程主机上服务的工具，它通过 SSH 协议实现管理节点与远程节点之间的通信，所以首先需要完成 ",-1)),p(e,{to:"/os/linux/login-with-rsa-key.html#%E7%94%9F%E6%88%90-rsa"},{default:t(()=>[...s[0]||(s[0]=[n("SSH 配置",-1)])]),_:1}),s[2]||(s[2]=n("。",-1))]),s[9]||(s[9]=l(`<p>需要注意的是 Ansible 需要开启公钥认证，也就是添加到 <code>known_hosts</code> 中，对于大批量的操作可以禁用该行为：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">vim</span> /etc/ansible/ansible.cfg</span>
...
<span class="line"></span></code></pre></div><h3 id="_4-安装-ansible" tabindex="-1"><a class="header-anchor" href="#_4-安装-ansible"><span>4. 安装 ansible</span></a></h3>`,12)),a("p",null,[s[4]||(s[4]=a("a",{href:"https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html#latest-release-via-dnf-or-yum",target:"_blank",rel:"noopener noreferrer"},"官网",-1)),s[5]||(s[5]=n("推荐的安装方式，当下载速度极慢时的",-1)),p(e,{to:"/tools/github/download-huge-project-from-github.html"},{default:t(()=>[...s[3]||(s[3]=[n("解决方案",-1)])]),_:1}),s[6]||(s[6]=n("。",-1))]),s[10]||(s[10]=l(`<div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">git</span> clone https://gitee.com/shanyuhai123/ansible.git</span>
