import{_ as a,p as s,q as n,a1 as e}from"./framework-49860b1b.js";const t={},o=e(`<h1 id="别名-alias" tabindex="-1"><a class="header-anchor" href="#别名-alias" aria-hidden="true">#</a> 别名 alias</h1><p>alias 可用于设置指令的别名，固化则需要存放于 <code>~/.bashrc</code> 或 <code>~/.zshrc</code> 中。</p><blockquote><p>有的时候命令历史提示会更好用，也就是需要更加了解 <code>zsh</code> 的生态。</p></blockquote><h2 id="常用规则" tabindex="-1"><a class="header-anchor" href="#常用规则" aria-hidden="true">#</a> 常用规则</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查找进程</span>
...
</code></pre></div>`,7),p=[o];function c(l,i){return s(),n("div",null,p)}const d=a(t,[["render",c],["__file","alias.html.vue"]]);export{d as default};
