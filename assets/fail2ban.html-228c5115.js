import{_ as e,M as t,p as o,q as l,Q as a,t as s,N as p,a1 as c}from"./framework-49860b1b.js";const r={},i=a("h1",{id:"fail2ban",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#fail2ban","aria-hidden":"true"},"#"),s(" fail2ban")],-1),d=a("div",{class:"custom-container danger"},[a("p",{class:"custom-container-title"},"重要"),a("p",null,"使得 fail2ban 生效，需要启用 firewalld 服务。")],-1),b={href:"https://github.com/fail2ban/fail2ban",target:"_blank",rel:"noopener noreferrer"},h=c(`<p>在启用 Web 服务后，常常会有一些脚本前来扫描是否存在漏洞，可以利用 <code>fail2ban</code> 禁用访问的 IP。还可以后端放出一些陷阱数据，正常用户界面不会展示，而一旦有爬虫访问了该数据，则禁用对应的 IP。</p><h2 id="使用" tabindex="-1"><a class="header-anchor" href="#使用" aria-hidden="true">#</a> 使用</h2><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 安装</span>
...
</code></pre></div>`,13);function k(u,f){const n=t("ExternalLinkIcon");return o(),l("div",null,[i,d,a("p",null,[s("服务器安全一直是一个问题，常使用 "),a("a",b,[s("fail2ban"),p(n)]),s(" 来防止 SSH 暴力破解。")]),h])}const _=e(r,[["render",k],["__file","fail2ban.html.vue"]]);export{_ as default};
