...
</code></pre></div><h2 id="内置的工具类型" tabindex="-1"><a class="header-anchor" href="#内置的工具类型" aria-hidden="true">#</a> 内置的工具类型</h2><p>想成为一个好的 TypeScript 开发者，那必须熟练使用它的工具类型。</p><h3 id="前置条件" tabindex="-1"><a class="header-anchor" href="#前置条件" aria-hidden="true">#</a> 前置条件</h3>`,31),d={href:"https://www.typescriptlang.org/docs/handbook/generics.html",target:"_blank",rel:"noopener noreferrer"},y={href:"https://www.typescriptlang.org/docs/handbook/2/types-from-types.html",target:"_blank",rel:"noopener noreferrer"},m=p(`<h4 id="_1-keyof-type-operator" tabindex="-1"><a class="header-anchor" href="#_1-keyof-type-operator" aria-hidden="true">#</a> 1. Keyof Type Operator</h4><p><code>keyof</code> 可用来获取 “对象类型” 的 <code>key</code>，并组成 <code>union</code>。</p><div class="language-tsx" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">type</span> <span class="token class-name">Point</span> <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token comment">// }</span>
</code></pre></div><h4 id="_6-template-literal-types" tabindex="-1"><a class="header-anchor" href="#_6-template-literal-types" aria-hidden="true">#</a> 6. Template Literal Types</h4><p>很好，就差支持正则了。</p><h4 id="_7-extends-in" tabindex="-1"><a class="header-anchor" href="#_7-extends-in" aria-hidden="true">#</a> 7. extends &amp; in</h4>`,21),g=n("code",null,"extends",-1),h=n("code",null,"in",-1),x={href:"https://stackoverflow.com/questions/57337598/in-typescript-what-do-extends-keyof-and-in-keyof-mean",target:"_blank",rel:"noopener noreferrer"},w=p(`<p>在泛型上提前做约束可以解决一些问题：</p><div class="language-tsx" data-ext="tsx"><pre class="language-tsx"><code><span class="token keyword">function</span> <span class="token generic-function"><span class="token function">prop</span><span class="token generic class-name"><span class="token operator">&lt;</span><span class="token constant">T</span><span class="token punctuation">,</span> <span class="token constant">K</span> <span class="token keyword">extends</span> <span class="token keyword">keyof</span> <span class="token constant">T</span><span class="token operator">&gt;</span></span></span> <span class="token punctuation">(</span>obj<span class="token operator">:</span> <span class="token constant">T</span><span class="token punctuation">,</span> key<span class="token operator">:</span> <span class="token constant">K</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre></div><h2 id="typescript-工具" tabindex="-1"><a class="header-anchor" href="#typescript-工具" aria-hidden="true">#</a> TypeScript 工具</h2>`,88),b={href:"https://www.typescriptlang.org/play",target:"_blank",rel:"noopener noreferrer"},f=n("p",null,"在线 TypeScript 运行环境",-1),T={href:"http://www.jsontots.com/",target:"_blank",rel:"noopener noreferrer"},v=n("p",null,"根据 JSON 生成 typescript 的工具，很赞",-1),_=n("h2",{id:"参考资料",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#参考资料","aria-hidden":"true"},"#"),s(" 参考资料")],-1),P={href:"https://www.typescriptlang.org/docs",target:"_blank",rel:"noopener noreferrer"},R={href:"https://www.typescriptlang.org/tsconfig",target:"_blank",rel:"noopener noreferrer"},O={href:"https://devblogs.microsoft.com/typescript/",target:"_blank",rel:"noopener noreferrer"},E={href:"https://github.com/microsoft/TypeScript/tree/spec-update/doc/spec",target:"_blank",rel:"noopener noreferrer"};function K(D,C){const a=o("ExternalLinkIcon");return c(),l("div",null,[k,n("p",null,[n("a",i,[s("interface"),t(a)]),s(" 从官网看来可以描述：对象、函数、数组、Class。")]),u,n("p",null,[n("a",d,[s("泛型"),t(a)]),s("是一切工具类型的基础，可以当作函数中的入参，而想要进一步则还需要借助 "),n("a",y,[s("Type Manipulation"),t(a)]),s("。")]),m,n("p",null,[g,s(" 和 "),h,s(" 都可以作为约束行为，实际使用中是让人"),n("a",x,[s("疑惑的"),t(a)]),s("，其中一条评论不知是否正确：“extends 总是用在泛型上，in 总是用在索引上”。")]),w,n("ul",null,[n("li",null,[n("p",null,[n("a",b,[s("TypeScript Playground"),t(a)])]),f]),n("li",null,[n("p",null,[n("a",T,[s("JSON TO TS"),t(a)])]),v])]),_,n("ol",null,[n("li",null,[n("a",P,[s("TypeScript"),t(a)])]),n("li",null,[n("a",R,[s("TSConfig Reference"),t(a)])]),n("li",null,[n("a",O,[s("TypeScript Blogs"),t(a)])]),n("li",null,[n("a",E,[s("TypeScript Spec"),t(a)])])])])}const I=e(r,[["render",K],["__file","index.html.vue"]]);export{I as default};
