...
</code></pre></div>`,9);function w(E,C){const a=o("OutboundLink");return i(),c(p,null,[h,s("p",null,[d,s("a",u,[g,e(a)]),k]),b,s("p",null,[_,s("a",f,[m,e(a)]),x]),v,s("p",null,[y,s("a",S,[L,e(a)]),T]),H],64)}var P=r(l,[["render",w]]);export{P as default};
