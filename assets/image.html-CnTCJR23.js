import{_ as a,c as n,a as e,o as p}from"./app-DLCc4AGN.js";const l={};function c(t,s){return p(),n("div",null,[...s[0]||(s[0]=[e(`<h1 id="了解-docker-镜像" tabindex="-1"><a class="header-anchor" href="#了解-docker-镜像"><span>了解 Docker 镜像</span></a></h1><h2 id="获取镜像" tabindex="-1"><a class="header-anchor" href="#获取镜像"><span>获取镜像</span></a></h2><div class="hint-container tip"><p class="hint-container-title">格式</p><p><code>docker pull [OPTIONS] NAME[:TAG|@DIGEST]</code>。</p><p>NAME 是镜像仓库名称（用来区分镜像），TAG 是镜像的标签（往往用来表示版本信息）。若不指定 TAG 则默认选择 <code>latest</code>，即最新版本。</p></div><p>在获取镜像前可以查询是否存在对应的镜像。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># docker search [OPTIONS] TERM</span></span>
