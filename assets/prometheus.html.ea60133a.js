import{r as o,c as p,a as s,b as e,F as c,d as n,e as t,o as l}from"./app.8db4efad.js";import{_ as r}from"./plugin-vue_export-helper.5a098b48.js";const u={},i=s("h2",{id:"\u90E8\u7F72",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#\u90E8\u7F72","aria-hidden":"true"},"#"),n(" \u90E8\u7F72")],-1),k=n("\u524D\u5F80"),d={href:"https://prometheus.io/download/",target:"_blank",rel:"noopener noreferrer"},m=n("\u5B98\u7F51"),h=n("\u4E0B\u8F7D\u6838\u5FC3\uFF1A"),_=t(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u89E3\u538B</span>
...
<span class="token function">sudo</span> systemctl status prometheus
</code></pre></div>`,1),g=n("\u4F7F\u7528 "),y={href:"https://hub.docker.com/u/prom",target:"_blank",rel:"noopener noreferrer"},b=n("Docker"),f=n(" \u6216 "),x={href:"https://github.com/cloudalchemy/ansible-prometheus",target:"_blank",rel:"noopener noreferrer"},v=n("Ansible"),q=n(" \u5219\u7B80\u5355\u8BB8\u591A\uFF1A"),w=t(`<div class="language-bash ext-sh"><pre class="language-bash"><code>docker run --restart<span class="token operator">=</span>always -d <span class="token punctuation">\\</span>
	...
	prom/prometheus
</code></pre></div><h2 id="\u914D\u7F6E\u6587\u4EF6" tabindex="-1"><a class="header-anchor" href="#\u914D\u7F6E\u6587\u4EF6" aria-hidden="true">#</a> \u914D\u7F6E\u6587\u4EF6</h2>`,2),j=n("\u9ED8\u8BA4 "),S={href:"https://prometheus.io/docs/prometheus/latest/configuration/configuration/",target:"_blank",rel:"noopener noreferrer"},A=n("prometheus.yml"),E=n(" \u5B9A\u4E49\u4E86 4 \u4E2A YAML \u5757\uFF1A"),P=s("code",null,"global",-1),D=n("\u3001"),O=s("code",null,"alerting",-1),F=n("\u3001"),N=s("code",null,"rule_files",-1),z=n(" \u548C "),B=s("code",null,"scrape_configs",-1),L=n("\u3002"),I=t(`<div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token comment"># my global config</span>
...
</code></pre></div><h2 id="\u76D1\u63A7\u793A\u4F8B" tabindex="-1"><a class="header-anchor" href="#\u76D1\u63A7\u793A\u4F8B" aria-hidden="true">#</a> \u76D1\u63A7\u793A\u4F8B</h2><h3 id="_1-node-exporter" tabindex="-1"><a class="header-anchor" href="#_1-node-exporter" aria-hidden="true">#</a> 1. node exporter</h3>`,8),T=n("\u4EE5\u7CFB\u7EDF\u6307\u6807 "),V={href:"https://prometheus.io/download/#node_exporter",target:"_blank",rel:"noopener noreferrer"},C=n("node_exporter"),U=n(" \u4E3A\u793A\u4F8B\uFF0C\u53EF\u53C2\u7167 "),M={href:"https://gist.github.com/jarek-przygodzki/735e15337a3502fea40beba27e193b04",target:"_blank",rel:"noopener noreferrer"},W=n("node_exporter-as-systemd-service"),G=n(" \u8FDB\u884C\u914D\u7F6E\uFF1A"),R=t(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u521B\u5EFA\u7528\u6237</span>
...
<span class="token function">sudo</span> systemctl status node_exporter
  ...
  google/cadvisor
</code></pre></div><h3 id="_3-\u65E5\u5FD7" tabindex="-1"><a class="header-anchor" href="#_3-\u65E5\u5FD7" aria-hidden="true">#</a> 3. \u65E5\u5FD7</h3><p>\u5BF9\u4E8E\u6CA1\u6709\u8BBE\u7F6E\u76D1\u63A7\u6216\u4E0D\u5BB9\u6613\u8FDB\u884C\u76D1\u63A7\u7684\u9057\u7559\u5E94\u7528\u7A0B\u5E8F\uFF0C\u91CD\u5199\u3001\u4FEE\u8865\u3001\u91CD\u6784\u7A0B\u5E8F\u4EE5\u66B4\u9732\u5185\u90E8\u72B6\u6001\u7684\u6210\u672C\u5F88\u9AD8\uFF0C\u800C\u4F7F\u7528\u65E5\u5FD7\u6570\u636E\u4F5C\u4E3A\u6293\u53D6\u65F6\u95F4\u5E8F\u5217\u6570\u636E\u7684\u6765\u6E90\u5219\u66F4\u5177\u6709\u53EF\u884C\u6027\u3002</p>`,8),$=n("\u5728 "),H={href:"https://github.com/google/mtail/tree/master/examples",target:"_blank",rel:"noopener noreferrer"},Y=n("examples"),J=n(" \u4E2D\u63D0\u4F9B\u4E86\u65E5\u5FD7\u89E3\u6790\u6A21\u677F\u3002"),K=t(`<div class="language-bash ext-sh"><pre class="language-bash"><code>docker run -dP <span class="token punctuation">\\</span>
...
</code></pre></div><h3 id="_4-\u9ED1\u76D2\u76D1\u63A7" tabindex="-1"><a class="header-anchor" href="#_4-\u9ED1\u76D2\u76D1\u63A7" aria-hidden="true">#</a> 4. \u9ED1\u76D2\u76D1\u63A7</h3>`,2),Q=n("\u53EF\u4EE5\u4F7F\u7528\u63A2\u9488\u76D1\u63A7\u6765\u67E5\u770B\u5E94\u7528\u7A0B\u5E8F\u7684\u5916\u90E8\u72B6\u6001\uFF0C"),X={href:"https://github.com/prometheus/blackbox_exporter",target:"_blank",rel:"noopener noreferrer"},Z=n("Blackbox exporter"),nn=n("\u3002"),sn=t(`<p>\u5148\u6307\u5B9A\u8981\u55C5\u63A2\u7684\u914D\u7F6E\u4FE1\u606F\uFF1A</p><div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token key atrule">modules</span><span class="token punctuation">:</span>
...
</code></pre></div><h3 id="_2-\u57FA\u4E8E-api" tabindex="-1"><a class="header-anchor" href="#_2-\u57FA\u4E8E-api" aria-hidden="true">#</a> 2. \u57FA\u4E8E API</h3><p>\u6682\u4E0D\u8003\u8651\u8BE5\u5F62\u5F0F\uFF0C\u5F85\u540E\u671F\u76F4\u63A5\u4E0A k8s\u3002</p><h3 id="_3-\u57FA\u4E8E-dns" tabindex="-1"><a class="header-anchor" href="#_3-\u57FA\u4E8E-dns" aria-hidden="true">#</a> 3. \u57FA\u4E8E DNS</h3>`,14),an=n("\u53EF\u914D\u5408 "),en={href:"https://github.com/jpillora/docker-dnsmasq",target:"_blank",rel:"noopener noreferrer"},tn=n("docker-dnsmasq"),on=n(" \u5FEB\u901F\u4F7F\u7528\u3002"),pn=t(`<div class="language-yaml ext-yml"><pre class="language-yaml"><code><span class="token comment"># prometheus \u8BBE\u7F6E</span>
...
dns3.example.com <span class="token number">10.0</span>.0.133
</code></pre></div><h2 id="\u56FE\u5F62\u754C\u9762" tabindex="-1"><a class="header-anchor" href="#\u56FE\u5F62\u754C\u9762" aria-hidden="true">#</a> \u56FE\u5F62\u754C\u9762</h2>`,4),cn=n("\u53EF\u4F7F\u7528 "),ln={href:"https://hub.docker.com/r/grafana/grafana",target:"_blank",rel:"noopener noreferrer"},rn=n("grafana"),un=n(" \u5B8C\u6210\u56FE\u5F62\u754C\u9762\uFF0C\u8FD8\u63D0\u4F9B\u4E86\u65B9\u4FBF\u7684 "),kn={href:"https://grafana.com/grafana/dashboards?plcmt=footer",target:"_blank",rel:"noopener noreferrer"},dn=n("Dashboards"),mn=n(" \u6765\u5BFC\u5165\u4ED6\u4EBA\u7684\u4F5C\u54C1\u3002"),hn=t(`<div class="language-bash ext-sh"><pre class="language-bash"><code>docker run --restart<span class="token operator">=</span>always -d <span class="token punctuation">\\</span>
	-p <span class="token number">3000</span>:3000 <span class="token punctuation">\\</span>
	--name grafana <span class="token punctuation">\\</span>
	grafana/grafana
</code></pre></div><p>\u7A0D\u540E\u8BBF\u95EE <code>10.0.0.128:3000</code> \u5E76\u4F7F\u7528 <code>admin/admin</code> \u8FDB\u884C\u767B\u5F55\uFF0C\u5728 <code>Configuration</code> \u542F\u7528 <code>Prometheus</code>\uFF0C\u7136\u540E\u5C31\u53EF\u4EE5\u5728 <code>Dashboards</code> \u7684 <code>Manage</code> \u4E2D\u67E5\u770B\u4E86\u3002</p><h2 id="\u8B66\u62A5" tabindex="-1"><a class="header-anchor" href="#\u8B66\u62A5" aria-hidden="true">#</a> \u8B66\u62A5</h2><p>\u826F\u597D\u7684\u8B66\u62A5\u5E94\u8BE5\u5177\u5907\u4EE5\u4E0B\u7279\u5F81\uFF1A</p><ol><li>\u9002\u5F53\u6570\u91CF\u7684\u8B66\u62A5\uFF0C\u5173\u6CE8\u75C7\u72B6\u800C\u4E0D\u662F\u539F\u56E0</li><li>\u5E94\u8BBE\u7F6E\u6B63\u786E\u7684\u8B66\u62A5\u4F18\u5148\u7EA7</li><li>\u8B66\u62A5\u5E94\u5305\u62EC\u9002\u5F53\u7684\u4E0A\u4E0B\u6587\uFF0C\u4EE5\u4FBF\u5B83\u4EEC\u53EF\u4EE5\u7ACB\u5373\u4F7F\u7528</li></ol><p>\u6211\u4EEC\u4F1A\u5728 Prometheus \u670D\u52A1\u5668\u4E0A\u7F16\u5199\u8B66\u62A5\u89C4\u5219\uFF0C\u8FD9\u4E9B\u89C4\u5219\u5C06\u4F7F\u7528\u6536\u96C6\u7684\u6307\u6807\u5E76\u5728\u6307\u5B9A\u7684\u9608\u503C\u6216\u6807\u51C6\u4E0A\u89E6\u53D1\u8B66\u62A5\uFF0C\u8FD8\u53EF\u4EE5\u4E3A\u8B66\u62A5\u6DFB\u52A0\u4E00\u4E9B\u4E0A\u4E0B\u6587\u3002\u5F53\u6307\u6807\u8FBE\u5230\u9608\u503C\u6216\u6807\u51C6\u65F6\uFF0C\u4F1A\u751F\u6210\u4E00\u4E2A\u8B66\u62A5\u5E76\u5C06\u5176\u63A8\u9001\u5230 Alertmanager\u3002</p>`,6),_n=n("\u53EF\u4EE5\u53C2\u8003\u4E00\u4E9B\u62A5\u8B66\u89C4\u5219 "),gn={href:"https://awesome-prometheus-alerts.grep.to/",target:"_blank",rel:"noopener noreferrer"},yn=n("Awesome Prometheus alerts"),bn=n("\u3002"),fn=t(`<h3 id="alertmanager" tabindex="-1"><a class="header-anchor" href="#alertmanager" aria-hidden="true">#</a> alertmanager</h3><p>Alertmanager \u4F1A\u5BF9\u8B66\u62A5\u8FDB\u884C\u53BB\u91CD\u3001\u5206\u7EC4\uFF0C\u7136\u540E\u8DEF\u7531\u5230\u4E0D\u540C\u7684\u63A5\u6536\u5668\uFF0C\u5982\u7535\u5B50\u90AE\u4EF6\u3001\u77ED\u4FE1\u6216 SaaS \u670D\u52A1\u7B49\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code>docker run --restart<span class="token operator">=</span>always -d <span class="token punctuation">\\</span>
	...
	prom/alertmanager
</code></pre></div><h3 id="\u914D\u7F6E\u6CE8\u610F\u9879" tabindex="-1"><a class="header-anchor" href="#\u914D\u7F6E\u6CE8\u610F\u9879" aria-hidden="true">#</a> \u914D\u7F6E\u6CE8\u610F\u9879</h3><p>\u9ED8\u8BA4 <code>prometheus.yml</code> \u4E2D <code>alertmanager:9093</code> \u5728 hosts \u89E3\u6790\u4E0B\u624D\u4F1A\u751F\u6548\uFF0C\u53EF\u624B\u52A8\u6307\u5B9A <code>ip:port</code> \u89E3\u51B3\u3002</p><p><code>alertmanager.yml</code> \u9ED8\u8BA4\u60C5\u51B5\u4E0B\u6240\u6709\u8B66\u62A5\u90FD\u7EC4\u5408\u5728\u4E00\u8D77\uFF0C\u6307\u5B9A <code>group_by: [&#39;instance&#39;]</code> \u53EF\u6839\u636E\u5B9E\u4F8B\u7EC4\u5408\u5728\u4E00\u8D77\u3002</p>`,6),xn=n("\u66F4\u591A\u914D\u7F6E\u53EF\u89C1 "),vn={href:"https://prometheus.io/docs/alerting/latest/configuration/#route",target:"_blank",rel:"noopener noreferrer"},qn=n("route"),wn=n("\u3002");function jn(Sn,An){const a=o("OutboundLink");return l(),p(c,null,[i,s("p",null,[k,s("a",d,[m,e(a)]),h]),_,s("p",null,[g,s("a",y,[b,e(a)]),f,s("a",x,[v,e(a)]),q]),w,s("p",null,[j,s("a",S,[A,e(a)]),E,P,D,O,F,N,z,B,L]),I,s("p",null,[T,s("a",V,[C,e(a)]),U,s("a",M,[W,e(a)]),G]),R,s("p",null,[$,s("a",H,[Y,e(a)]),J]),K,s("p",null,[Q,s("a",X,[Z,e(a)]),nn]),sn,s("p",null,[an,s("a",en,[tn,e(a)]),on]),pn,s("p",null,[cn,s("a",ln,[rn,e(a)]),un,s("a",kn,[dn,e(a)]),mn]),hn,s("p",null,[_n,s("a",gn,[yn,e(a)]),bn]),fn,s("p",null,[xn,s("a",vn,[qn,e(a)]),wn])],64)}var Dn=r(u,[["render",jn]]);export{Dn as default};
