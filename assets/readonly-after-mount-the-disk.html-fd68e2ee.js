import{_ as n,p as a,q as s,a1 as e}from"./framework-49860b1b.js";const t={},o=e(`<h1 id="manjaro-挂载硬盘后只读" tabindex="-1"><a class="header-anchor" href="#manjaro-挂载硬盘后只读" aria-hidden="true">#</a> Manjaro 挂载硬盘后只读</h1><h2 id="情况" tabindex="-1"><a class="header-anchor" href="#情况" aria-hidden="true">#</a> 情况</h2><p>双系统使用情况下，当切换系统时挂载硬盘时仅具有只读权限。</p><p>直接使用 <code>dolpgin</code> 操作无提示，后采用命令行操作得到提示：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">mount</span> /dev/sda2 /run/media/shanyuhai/GROCERY
...
</code></pre></div><p>再次尝试在文件夹内进行编辑、删除操作发现可行了。</p>`,9),c=[o];function d(p,i){return a(),s("div",null,c)}const l=n(t,[["render",d],["__file","readonly-after-mount-the-disk.html.vue"]]);export{l as default};
