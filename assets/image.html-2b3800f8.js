import{_ as t,M as c,p,q as r,a1 as s,R as e,t as n,N as d}from"./framework-e3e34937.js";const l={},i={href:"https://github.com/docker-slim/docker-slim/releases",target:"_blank",rel:"noopener noreferrer"};function k(u,a){const o=c("ExternalLinkIcon");return p(),r("div",null,[a[3]||(a[3]=s(`<h1 id="了解-docker-镜像" tabindex="-1"><a class="header-anchor" href="#了解-docker-镜像" aria-hidden="true">#</a> 了解 Docker 镜像</h1><h2 id="获取镜像" tabindex="-1"><a class="header-anchor" href="#获取镜像" aria-hidden="true">#</a> 获取镜像</h2><div class="custom-container tip"><p class="custom-container-title">格式</p><p><code>docker pull [OPTIONS] NAME[:TAG|@DIGEST]</code>。</p><p>NAME 是镜像仓库名称（用来区分镜像），TAG 是镜像的标签（往往用来表示版本信息）。若不指定 TAG 则默认选择 <code>latest</code>，即最新版本。</p></div><p>在获取镜像前可以查询是否存在对应的镜像。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># docker search [OPTIONS] TERM</span>
...
</code></pre></div><h2 id="docker-slim-优化镜像" tabindex="-1"><a class="header-anchor" href="#docker-slim-优化镜像" aria-hidden="true">#</a> Docker slim 优化镜像</h2>`,44)),e("p",null,[a[1]||(a[1]=n("首先需要获取 ")),e("a",i,[a[0]||(a[0]=n("Docker Slim")),d(o)]),a[2]||(a[2]=n("。"))]),a[4]||(a[4]=s(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 下载</span>
...
</code></pre></div>`,3))])}const m=t(l,[["render",k],["__file","image.html.vue"]]);export{m as default};
