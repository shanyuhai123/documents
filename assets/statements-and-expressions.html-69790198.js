...
b<span class="token punctuation">;</span> <span class="token comment">// 42</span>
c<span class="token punctuation">;</span> <span class="token comment">// 42</span>
</code></pre></div><p>错误的创建了全局变量。</p>`,32),o=[t];function c(l,r){return n(),s("div",null,o)}const k=a(e,[["render",c],["__file","statements-and-expressions.html.vue"]]);export{k as default};
