import{_ as i,c as o,b as a,a as p,d as n,e as l,w as t,r as c,o as r}from"./app-DLCc4AGN.js";const k={};function g(d,s){const e=c("RouteLink");return r(),o("div",null,[s[6]||(s[6]=a("h1",{id:"为-nginx-配置-systemd-服务",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#为-nginx-配置-systemd-服务"},[a("span",null,"为 Nginx 配置 systemd 服务")])],-1)),a("p",null,[s[1]||(s[1]=n("当使用",-1)),l(e,{to:"/backend/nginx/install-nginx.html#%E7%BC%96%E8%AF%91%E5%AE%89%E8%A3%85"},{default:t(()=>[...s[0]||(s[0]=[n("编译安装 Nginx",-1)])]),_:1}),s[2]||(s[2]=n(" 后，同样希望将 Nginx 加入至 systemd 进行管理，如果可以的话希望进一步对该 Nginx 进行区分。",-1))]),s[7]||(s[7]=p(`<h2 id="阅读" tabindex="-1"><a class="header-anchor" href="#阅读"><span>阅读</span></a></h2><p>首先需要了解一下 yum 安装的 Nginx 配置：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">systemctl <span class="token function">cat</span> nginx.service</span>
...
<span class="line"></span></code></pre></div>`,8)),a("p",null,[s[4]||(s[4]=n("接着按照",-1)),l(e,{to:"/backend/nginx/install-nginx.html#_2-%E4%B8%8B%E8%BD%BD"},{default:t(()=>[...s[3]||(s[3]=[n("之前",-1)])]),_:1}),s[5]||(s[5]=n("操作。",-1))]),s[8]||(s[8]=p(`<h3 id="_2-编译" tabindex="-1"><a class="header-anchor" href="#_2-编译"><span>2. 编译</span></a></h3><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line">./configure <span class="token parameter variable">--help</span> <span class="token operator">|</span> <span class="token function">less</span> <span class="token comment"># 查看帮助</span></span>
