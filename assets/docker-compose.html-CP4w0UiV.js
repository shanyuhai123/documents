import{_ as n,c as a,a as e,o as p}from"./app-CVsCLQsN.js";const t={};function l(c,s){return p(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="docker-compose-管理多个服务" tabindex="-1"><a class="header-anchor" href="#docker-compose-管理多个服务"><span>Docker Compose 管理多个服务</span></a></h1><h2 id="为什么需要-docker-compose" tabindex="-1"><a class="header-anchor" href="#为什么需要-docker-compose"><span>为什么需要 Docker Compose</span></a></h2><p>先简单理解 Docker 的使用过程：</p><ol><li>镜像构建：即创建一个镜像，这个创建的过程就是用 <code>Dockerfile</code> 来完成的。</li><li>容器启动：针对单个容器可以使用 <code>docker run</code> 来启动，那多个呢？于是就出现了 Docker Compose。</li></ol><h3 id="_1-说明" tabindex="-1"><a class="header-anchor" href="#_1-说明"><span>1. 说明</span></a></h3><p>Docker Compose 中定义的每个服务都必须通过 <code>image</code> 或 <code>build</code> 指令来构建，<code>build</code> 时会应用 <code>Dockerfile</code> 中的配置，无需重复设置。</p><h3 id="_2-默认" tabindex="-1"><a class="header-anchor" href="#_2-默认"><span>2. 默认</span></a></h3><p>默认模板文件为 <code>docker-compose.yml</code>，默认的项目名称为所在目录名。</p><h2 id="安装卸载" tabindex="-1"><a class="header-anchor" href="#安装卸载"><span>安装卸载</span></a></h2><p>选择二进制安装的形式，更多版本可见 <a href="https://github.com/docker/compose/releases" target="_blank" rel="noopener noreferrer">github release</a>。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># 下载</span></span>
