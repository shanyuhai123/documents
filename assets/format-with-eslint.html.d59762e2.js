...
<span class="token function">touch</span> .prettierignore
 ...
 plugins<span class="token operator">:</span> <span class="token punctuation">[</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre></div>`,5);function Q(R,U){const a=o("OutboundLink");return i(),p(c,null,[u,n("p",null,[d,n("a",k,[h,e(a)]),g]),_,n("p",null,[v,n("a",m,[f,e(a)]),x]),b,n("ul",null,[q,n("li",null,[j,y,S,E,L,V,n("a",w,[O,e(a)])]),D]),N,n("p",null,[B,C,T,n("a",A,[F,e(a)]),P]),J,n("p",null,[W,z,G,n("a",H,[I,e(a)]),K]),M],64)}var Z=r(l,[["render",Q]]);export{Z as default};
