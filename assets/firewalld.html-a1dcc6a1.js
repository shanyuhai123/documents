import{_ as e,M as o,p,q as r,Q as s,t as a,N as l,a1 as n}from"./framework-49860b1b.js";const c={},d=n(`<h1 id="防火墙-firewalld" tabindex="-1"><a class="header-anchor" href="#防火墙-firewalld" aria-hidden="true">#</a> 防火墙 firewalld</h1><p>firewalld 是 CentOS 7 新增的特性，其支持动态更新，且添加了防火墙 &quot;zones&quot; 的概念。</p><p>firewalld 与 iptables 自身并不具备防火墙的功能，都需要通过内核的 netfilter 来实现，它们的作用都是维护过滤的规则。</p><p>firewalld 的配置文件存放在 <code>/usr/lib/firewalld/</code> 和 <code>/etc/firewalld/</code> 里的 XML 文件中。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 安装</span>
...
</code></pre></div><h3 id="_4-rich-rule" tabindex="-1"><a class="header-anchor" href="#_4-rich-rule" aria-hidden="true">#</a> 4. rich-rule</h3>`,23),i={href:"https://access.redhat.com/documentation/zh_cn/red_hat_enterprise_linux/7/html/security_guide/sec-using_firewalls#Configuring_Complex_Firewall_Rules_with_the_Rich-Language_Syntax",target:"_blank",rel:"noopener noreferrer"},u=n(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code>rule <span class="token punctuation">[</span>family<span class="token operator">=</span><span class="token string">&quot;&lt;rule family&gt;&quot;</span><span class="token punctuation">]</span>
...
</code></pre></div>`,1);function m(k,h){const t=o("ExternalLinkIcon");return p(),r("div",null,[d,s("p",null,[a("多规则命令的格式或结构如下（及"),s("a",i,[a("解释"),l(t)]),a("）：")]),u])}const b=e(c,[["render",m],["__file","firewalld.html.vue"]]);export{b as default};
