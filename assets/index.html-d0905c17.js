...
</code></pre></div><h3 id="git-飞行规则" tabindex="-1"><a class="header-anchor" href="#git-飞行规则" aria-hidden="true">#</a> Git 飞行规则</h3>`,41)),s("p",null,[s("a",h,[a[0]||(a[0]=n("Git飞行规则(Flight Rules)")),e(t)]),a[1]||(a[1]=n(" 可以用来指导一些常见的问题。"))]),a[6]||(a[6]=p(`<h2 id="为-git-添加代理" tabindex="-1"><a class="header-anchor" href="#为-git-添加代理" aria-hidden="true">#</a> 为 Git 添加代理</h2><p>clone 大项目时总是乏力，下载速度极慢，这时就需要为其设置代理了。</p><h3 id="全局代理" tabindex="-1"><a class="header-anchor" href="#全局代理" aria-hidden="true">#</a> 全局代理</h3><p>该项可参考 alias 部分内容。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>gfw
...
</code></pre></div><h3 id="git-代理协议的补充" tabindex="-1"><a class="header-anchor" href="#git-代理协议的补充" aria-hidden="true">#</a> Git 代理协议的补充</h3><p>git 代理支持多种协议：http、https、socks、socks5，本机通过 ss 启用了 socks5。</p><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>`,10)),s("ul",null,[s("li",null,[s("a",u,[a[2]||(a[2]=n("Github")),e(t)])]),s("li",null,[s("a",g,[a[3]||(a[3]=n("Git-scm")),e(t)])]),s("li",null,[s("a",m,[a[4]||(a[4]=n("shafiul Community Book")),e(t)])])])])}const v=o(d,[["render",b],["__file","index.html.vue"]]);export{v as default};
