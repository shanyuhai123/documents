import{_ as n,c as a,a as e,o as p}from"./app-CQrWi6O2.js";const t={};function l(o,s){return p(),a("div",null,[...s[0]||(s[0]=[e(`<h1 id="trigger" tabindex="-1"><a class="header-anchor" href="#trigger"><span>TRIGGER</span></a></h1><p>触发器是在 INSERT、UPDATE、DELETE 语句前后自动执行的一段。</p><p>每个表每个事件每次只允许一个触发器，因此每个表最多支持 6 个触发器（每条 INSERT、UPDATE、DELETE 的之前和之后）。</p><h2 id="实践" tabindex="-1"><a class="header-anchor" href="#实践"><span>实践</span></a></h2><h3 id="insert" tabindex="-1"><a class="header-anchor" href="#insert"><span>INSERT</span></a></h3><p><a href="https://blog.csdn.net/qinzaoxiaozhu/article/details/111037233" target="_blank" rel="noopener noreferrer">MYSQL5以后，不允许触发器返回任何结果</a>，而且缺乏返回的对比，不如为其新增一列。</p><div class="language-sql" data-highlighter="prismjs" data-ext="sql" data-title="sql"><pre><code><span class="line"><span class="token keyword">DROP</span> <span class="token keyword">TRIGGER</span> <span class="token keyword">IF</span> <span class="token keyword">EXISTS</span> orders_after_insert<span class="token punctuation">;</span></span>
