import{_ as o,M as p,p as c,q as i,Q as n,t as a,N as e,a1 as t}from"./framework-49860b1b.js";const l={},r=n("h1",{id:"nginx-的限制模块",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nginx-的限制模块","aria-hidden":"true"},"#"),a(" Nginx 的限制模块")],-1),d=n("h2",{id:"请求限制",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#请求限制","aria-hidden":"true"},"#"),a(" 请求限制")],-1),k={href:"https://nginx.org/en/docs/http/ngx_http_limit_req_module.html",target:"_blank",rel:"noopener noreferrer"},u=t(`<h3 id="_1-limit-req-zone" tabindex="-1"><a class="header-anchor" href="#_1-limit-req-zone" aria-hidden="true">#</a> 1. limit_req_zone</h3><p>首先需要在 <code>http</code> 作用域定义 <code>limit_req_zone</code>。</p><div class="language-nginx" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">Syntax:</span> limit_req_zone key zone=name:size rate=rate [sync]</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p><code>$binary_remote_addr</code> 相对 <code>remote_addr</code> 占用的空间更少。</p><h2 id="连接限制" tabindex="-1"><a class="header-anchor" href="#连接限制" aria-hidden="true">#</a> 连接限制</h2>`,8),_={href:"https://nginx.org/en/docs/http/ngx_http_limit_conn_module.html",target:"_blank",rel:"noopener noreferrer"},h=t(`<h3 id="_1-limit-conn-zone" tabindex="-1"><a class="header-anchor" href="#_1-limit-conn-zone" aria-hidden="true">#</a> 1. limit_conn_zone</h3><div class="language-nginx" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">Syntax:</span> limit_conn_zone key zone=name:size</span><span class="token punctuation">;</span>
<span class="token directive"><span class="token keyword">Default:</span> —
Context: http
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="访问-ip-限制" tabindex="-1"><a class="header-anchor" href="#访问-ip-限制" aria-hidden="true">#</a> 访问 IP 限制</h2>`,5),m={href:"https://nginx.org/en/docs/http/ngx_http_access_module.html",target:"_blank",rel:"noopener noreferrer"},x=t(`<div class="language-nginx" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">Syntax:</span> allow address | CIDR | unix: | all</span><span class="token punctuation">;</span>
<span class="token directive"><span class="token keyword">Default:</span> —
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="访问-账号-限制" tabindex="-1"><a class="header-anchor" href="#访问-账号-限制" aria-hidden="true">#</a> 访问 账号 限制</h2>`,2),v={href:"https://nginx.org/en/docs/http/ngx_http_auth_basic_module.html",target:"_blank",rel:"noopener noreferrer"},g=t(`<h3 id="_1-生成密码" tabindex="-1"><a class="header-anchor" href="#_1-生成密码" aria-hidden="true">#</a> 1. 生成密码</h3><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 生成密码工具 htpasswd</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,4);function y(b,f){const s=p("ExternalLinkIcon");return c(),i("div",null,[r,d,n("p",null,[a("请求限制 "),n("a",k,[a("limit_req_module"),e(s)]),a(" 比连接限制更优化，由于一个连接可以被多次复用。")]),u,n("p",null,[n("a",_,[a("limit_conn_module"),e(s)]),a(" 步骤基本与请求限制一致。")]),h,n("p",null,[n("a",m,[a("access_module"),e(s)]),a(" 可用来限制访问的 IP，用法比较简单。")]),x,n("p",null,[n("a",v,[a("auth_basic_module"),e(s)]),a(" 可以为路径添加用户密码访问，可配合 IP 限制使用。")]),g])}const z=o(l,[["render",y],["__file","limit-module.html.vue"]]);export{z as default};
