import{_ as o,M as p,p as c,q as l,a1 as r,R as n,t as e,N as t}from"./framework-e3e34937.js";const i={},d={href:"https://github.com/goharbor/harbor",target:"_blank",rel:"noopener noreferrer"},h={href:"https://goharbor.io/docs/2.1.0/install-config/configure-https/",target:"_blank",rel:"noopener noreferrer"},u={href:"https://github.com/goharbor/harbor/issues/13553",target:"_blank",rel:"noopener noreferrer"};function b(k,a){const s=p("ExternalLinkIcon");return c(),l("div",null,[a[13]||(a[13]=r(`<h1 id="使用-harbor-构建私有镜像仓库" tabindex="-1"><a class="header-anchor" href="#使用-harbor-构建私有镜像仓库" aria-hidden="true">#</a> 使用 Harbor 构建私有镜像仓库</h1><h2 id="环境" tabindex="-1"><a class="header-anchor" href="#环境" aria-hidden="true">#</a> 环境</h2><p>创建一台虚拟机为私有仓库，本机向虚拟机的仓库发起上传和下载。</p><h2 id="搭建仓库" tabindex="-1"><a class="header-anchor" href="#搭建仓库" aria-hidden="true">#</a> 搭建仓库</h2><p>在虚拟机上创建仓库，并指定镜像文件存放在本地的默认路径，为其设置 docker 重启后跟随重启。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">--restart</span><span class="token operator">=</span>always <span class="token parameter variable">--name</span> registry <span class="token parameter variable">-p</span> <span class="token number">5000</span>:5000 <span class="token parameter variable">-v</span> /opt/data/registry:/var/lib/registry registry
...
<span class="token comment"># 验证</span>
<span class="token function">docker</span> images
</code></pre></div><h2 id="harbor" tabindex="-1"><a class="header-anchor" href="#harbor" aria-hidden="true">#</a> Harbor</h2>`,15)),n("p",null,[a[1]||(a[1]=e("另外一个选择是使用 ")),n("a",d,[a[0]||(a[0]=e("Harbor")),t(s)]),a[2]||(a[2]=e("。"))]),a[14]||(a[14]=r(`<h3 id="_1-获取-harbor" tabindex="-1"><a class="header-anchor" href="#_1-获取-harbor" aria-hidden="true">#</a> 1. 获取 Harbor</h3><p>先下载文件。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 目标压缩包</span>
...
</code></pre></div><h3 id="_3-重装" tabindex="-1"><a class="header-anchor" href="#_3-重装" aria-hidden="true">#</a> 3. 重装</h3><p>当修改配置后运行 <code>bash prepare</code> 即可。</p><h3 id="_4-用户" tabindex="-1"><a class="header-anchor" href="#_4-用户" aria-hidden="true">#</a> 4. 用户</h3><p>Harbor 使用前需要注册帐号，推送镜像前需要先创建项目，邀请成员才行。</p><h2 id="自签证书" tabindex="-1"><a class="header-anchor" href="#自签证书" aria-hidden="true">#</a> 自签证书</h2><p>Harbor 在非 <code>https</code> 的环境下总是会出现各种各样的问题，而内网使用时需要自签证书解决 <code>https</code> 问题。</p>`,19)),n("p",null,[a[4]||(a[4]=e("Harbor 官网对这一部分有详细的")),n("a",h,[a[3]||(a[3]=e("说明")),t(s)]),a[5]||(a[5]=e("，此处稍微简化。"))]),a[15]||(a[15]=r(`<h3 id="_1-生成-ca-证书" tabindex="-1"><a class="header-anchor" href="#_1-生成-ca-证书" aria-hidden="true">#</a> 1. 生成 CA 证书</h3><p>先生成 <code>ca</code> 私钥：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>openssl genrsa <span class="token parameter variable">-out</span> ca.key <span class="token number">4096</span>
...
EOF</span>
    ...
    └── harbor.xxx.com
       ...
       ├── harbor.xxx.com.key
       └── ca.crt
</code></pre></div><p>配置完成后还需重启 Docker。</p><h3 id="_4-浏览器使用" tabindex="-1"><a class="header-anchor" href="#_4-浏览器使用" aria-hidden="true">#</a> 4. 浏览器使用</h3><p>Manjaro 下找到 SSL 设置，添加 <code>harbor.xxx.com.crt</code> 证书即可。</p><h3 id="_5-注意事项" tabindex="-1"><a class="header-anchor" href="#_5-注意事项" aria-hidden="true">#</a> 5. 注意事项</h3>`,24)),n("p",null,[a[7]||(a[7]=e("在使用 Nginx 反向代理 ")),a[8]||(a[8]=n("code",null,"push",-1)),a[9]||(a[9]=e(" 存在")),n("a",u,[a[6]||(a[6]=e("问题")),t(s)]),a[10]||(a[10]=e("。根据 ")),a[11]||(a[11]=n("code",null,"common/config/nginx/nginx.conf",-1)),a[12]||(a[12]=e(" 中的提示注释，需注意不止一处："))]),a[16]||(a[16]=n("div",{class:"language-nginx","data-ext":"nginx"},[n("pre",{class:"language-nginx"},[n("code",null,[n("span",{class:"token comment"},"# When setting up Harbor behind other proxy, such as an Nginx instance, remove the below line if the proxy already has similar settings."),e(`
`),n("span",{class:"token comment"},"#proxy_set_header X-Forwarded-Proto $scheme;"),e(`
`)])])],-1))])}const m=o(i,[["render",b],["__file","private-registry.html.vue"]]);export{m as default};
