import{_ as s,c as n,a as e,o as p}from"./app-CVsCLQsN.js";const l={};function t(c,a){return p(),n("div",null,[...a[0]||(a[0]=[e(`<h1 id="linux-常用命令" tabindex="-1"><a class="header-anchor" href="#linux-常用命令"><span>Linux 常用命令</span></a></h1><p>终究还是要提取出常用命令，记忆越来越差了。</p><p>发现一篇更好的总结 <a href="https://linux.cn/article-12959-1.html" target="_blank" rel="noopener noreferrer">初次登录 Linux 服务器马上要做的 9 件事</a>。</p><h2 id="第一次接触" tabindex="-1"><a class="header-anchor" href="#第一次接触"><span>第一次接触</span></a></h2><p>当登录一台服务器时，了解一下当前环境更好。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">cat</span> /etc/*-release</span>
