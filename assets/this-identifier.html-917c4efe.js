import{_ as t,M as p,p as o,q as c,Q as e,t as n,N as u,V as l,a1 as s}from"./framework-49860b1b.js";const i={},k=s(`<h1 id="什么是-this" tabindex="-1"><a class="header-anchor" href="#什么是-this" aria-hidden="true">#</a> 什么是 this</h1><p>虽然 <code>this</code> 可能经常看起来是与 “面向对象模式” 有关的，但在 JavaScript 中 <code>this</code> 是一个不同的概念。</p><p><code>this</code> 不是指向函数本身，即它不是编写时绑定，而是运行时绑定。</p><p><code>this</code> 机制帮助函数以更优雅的方式来隐式 “传递” 一个对象。</p><div class="language-javascript" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">identify</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre></div>`,2);function d(f,m){const a=p("RouterLink");return o(),c("div",null,[k,e("p",null,[n("相对于"),u(a,{to:"/frontend/javascript/this-and-object-prototypes.html#_1-%E7%9B%B4%E7%99%BD%E7%9A%84"},{default:l(()=>[n("直白的")]),_:1}),n("中介绍的四种规则，然而 ES6 引入的箭头函数（arrow function）并不适用。")]),r])}const b=t(i,[["render",d],["__file","this-identifier.html.vue"]]);export{b as default};
