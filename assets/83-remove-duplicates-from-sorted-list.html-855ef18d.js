import{_ as n,p as a,q as s,a1 as t}from"./framework-49860b1b.js";const p={},e=t(`<h1 id="删除排序链表中的重复元素" tabindex="-1"><a class="header-anchor" href="#删除排序链表中的重复元素" aria-hidden="true">#</a> 删除排序链表中的重复元素</h1><h2 id="遍历" tabindex="-1"><a class="header-anchor" href="#遍历" aria-hidden="true">#</a> 遍历</h2><p>由于数据是排序的，所以遍历即可。</p><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">deleteDuplicates</span><span class="token punctuation">(</span>head<span class="token operator">:</span> ListNode <span class="token operator">|</span> <span class="token keyword">null</span><span class="token punctuation">)</span><span class="token operator">:</span> ListNode <span class="token operator">|</span> <span class="token keyword">null</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,4),o=[e];function c(l,u){return a(),s("div",null,o)}const i=n(p,[["render",c],["__file","83-remove-duplicates-from-sorted-list.html.vue"]]);export{i as default};
