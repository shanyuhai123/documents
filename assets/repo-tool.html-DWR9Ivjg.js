import{_ as s,c as n,a as e,o as p}from"./app-BCSwjUcF.js";const t={};function o(l,a){return p(),n("div",null,a[0]||(a[0]=[e(`<h1 id="多仓库工具-repo" tabindex="-1"><a class="header-anchor" href="#多仓库工具-repo"><span>多仓库工具 Repo</span></a></h1><h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言"><span>前言</span></a></h2><p>有个小任务，拉取 <a href="https://www.chromium.org/chromium-os/quick-start-guide" target="_blank" rel="noopener noreferrer">Chromium OS</a> 的代码：</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token builtin class-name">cd</span> <span class="token variable">\${SOURCE_REPO}</span></span>
