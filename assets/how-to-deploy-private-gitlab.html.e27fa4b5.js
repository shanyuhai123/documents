import{r as o,c as p,a as s,b as t,F as c,e,d as n,o as l}from"./app.b7a98728.js";import{_ as r}from"./plugin-vue_export-helper.5a098b48.js";const i={},u=e(`<h1 id="\u5982\u4F55\u642D\u5EFA\u79C1\u6709-gitlab" tabindex="-1"><a class="header-anchor" href="#\u5982\u4F55\u642D\u5EFA\u79C1\u6709-gitlab" aria-hidden="true">#</a> \u5982\u4F55\u642D\u5EFA\u79C1\u6709 GitLab</h1><h2 id="\u5B89\u88C5-gitlab" tabindex="-1"><a class="header-anchor" href="#\u5B89\u88C5-gitlab" aria-hidden="true">#</a> \u5B89\u88C5 GitLab</h2><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u521B\u5EFA\u6570\u636E\u76EE\u5F55</span>
...
</code></pre></div><p>\u6700\u540E\u6253\u5F00\u6D4F\u89C8\u5668\u6765\u9A8C\u8BC1\u3002</p><h2 id="\u90AE\u4EF6\u670D\u52A1" tabindex="-1"><a class="header-anchor" href="#\u90AE\u4EF6\u670D\u52A1" aria-hidden="true">#</a> \u90AE\u4EF6\u670D\u52A1</h2>`,5),k=n("\u591A\u5BB6\u5BF9\u6BD4\u540E\u9009\u62E9\u4E86"),d={href:"https://exmail.qq.com/",target:"_blank",rel:"noopener noreferrer"},g=n("\u817E\u8BAF\u4F01\u4E1A\u90AE\u7BB1"),m=n("\uFF0C\u4F9D\u6B21\u8FDB\u5165 "),h=s("code",null,"\u90AE\u7BB1 => \u90AE\u7BB1\u8BBE\u7F6E => \u6536\u53D1\u4FE1\u8BBE\u7F6E => \u5F00\u542FIMAP/SMTP\u670D\u52A1",-1),b=n("\uFF0C\u518D\u56DE\u5230 "),_=s("code",null,"\u90AE\u7BB1\u8BBE\u7F6E => \u90AE\u7BB1\u7ED1\u5B9A => \u5B89\u5168\u767B\u5F55",-1),v=n(" \u83B7\u53D6\u6388\u6743\u7801\u5373\u53EF\uFF08\u81F3\u4E8E\u914D\u7F6E\u57DF\u540D\uFF0C\u90AE\u4EF6\u914D\u7F6E\u53EF\u53E6\u884C\u8C37\u6B4C\uFF09\u3002"),f=e(`<h3 id="_1-\u4FEE\u6539\u914D\u7F6E" tabindex="-1"><a class="header-anchor" href="#_1-\u4FEE\u6539\u914D\u7F6E" aria-hidden="true">#</a> 1. \u4FEE\u6539\u914D\u7F6E</h3><p>\u627E\u5230 <code>Email Settings</code> \u5728\u540E\u9762\u8FFD\u52A0\u5BF9\u5E94\u7684 <code>SMTP</code> \u914D\u7F6E\u3002</p><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">vim</span> /srv/gitlab/config/gitlab.rb
...
<span class="token number">0</span> <span class="token number">4</span> * * * docker <span class="token builtin class-name">exec</span> -t gitlab gitlab-backup create <span class="token operator">&amp;&gt;</span> /dev/null
<span class="token comment"># \u6BCF\u5929\u51CC\u66684\u70B9\u5907\u4EFD\u5220\u9664 7 \u5929\u524D\u5907\u4EFD</span>
<span class="token number">0</span> <span class="token number">4</span> * * * <span class="token function">find</span> /srv/gitlab/data/backups/ -mtime +7 -name <span class="token string">&quot;*gitlab_backup.tar&quot;</span> -delete <span class="token operator">&amp;&gt;</span> /dev/null
...
</code></pre></div><h2 id="\u5FEB\u901F\u800C\u7B80\u5355\u7684\u5347\u7EA7" tabindex="-1"><a class="header-anchor" href="#\u5FEB\u901F\u800C\u7B80\u5355\u7684\u5347\u7EA7" aria-hidden="true">#</a> \u5FEB\u901F\u800C\u7B80\u5355\u7684\u5347\u7EA7</h2>`,19),x=n("\u4F7F\u7528 Docker Compose \u8FDB\u884C\u7EF4\u62A4\uFF0C\u627E\u5230\u65B0\u7684"),q={href:"https://hub.docker.com/r/gitlab/gitlab-ce/tags",target:"_blank",rel:"noopener noreferrer"},y=n("\u955C\u50CF"),T=n("\u66FF\u6362\u4E0A\uFF0C\u6CE8\u610F\u5927\u7248\u672C\u7684\u5347\u7EA7\u53D8\u52A8\uFF0C\u9700\u6309\u7167"),w={href:"https://docs.gitlab.com/ee/update/#upgrade-paths",target:"_blank",rel:"noopener noreferrer"},N=n("\u5347\u7EA7\u8DEF\u5F84"),P=n("\u8FDB\u884C\u5347\u7EA7\u3002"),S=e(`<div class="language-bash ext-sh"><pre class="language-bash"><code>docker-compose down
docker-compose up
...
</code></pre></div><h3 id="privileged" tabindex="-1"><a class="header-anchor" href="#privileged" aria-hidden="true">#</a> privileged</h3><p>\u5F53\u5B58\u5728 <code>error during connect no such host</code> \u62A5\u9519\u65F6\u4FEE\u6539 runner config \u7684 <code>privileged</code> \u5C5E\u6027\u4E3A <code>true</code>\u3002</p><h3 id="\u81EA\u7B7E\u8BC1\u4E66" tabindex="-1"><a class="header-anchor" href="#\u81EA\u7B7E\u8BC1\u4E66" aria-hidden="true">#</a> \u81EA\u7B7E\u8BC1\u4E66</h3>`,11),G=n("\u6839\u636E "),L={href:"https://docs.gitlab.com/runner/configuration/tls-self-signed.html",target:"_blank",rel:"noopener noreferrer"},M=n("tls-self-signed"),R=n(" \u53BB\u4FE1\u4EFB ca\uFF1A"),B=e(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u5BBF\u4E3B\u673A</span>
...
</code></pre></div>`,1);function E(O,C){const a=o("OutboundLink");return l(),p(c,null,[u,s("p",null,[k,s("a",d,[g,t(a)]),m,h,b,_,v]),f,s("p",null,[x,s("a",q,[y,t(a)]),T,s("a",w,[N,t(a)]),P]),S,s("p",null,[G,s("a",L,[M,t(a)]),R]),B],64)}var A=r(i,[["render",E]]);export{A as default};
