...
EOF</span>
</code></pre></div><h2 id="初始化操作" tabindex="-1"><a class="header-anchor" href="#初始化操作" aria-hidden="true">#</a> 初始化操作</h2><h3 id="_1-关闭防火墙" tabindex="-1"><a class="header-anchor" href="#_1-关闭防火墙" aria-hidden="true">#</a> 1. 关闭防火墙</h3>`,7),i={href:"https://kubernetes.io/zh/docs/setup/production-environment/tools/kubeadm/install-kubeadm/#check-required-ports",target:"_blank",rel:"noopener noreferrer"},k=s(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code>systemctl stop firewalld
...
</code></pre></div>`,34),u={href:"https://github.com/coreos/flannel/releases",target:"_blank",rel:"noopener noreferrer"},h=e("code",null,"docker pull",-1),b=e("code",null,"docker load",-1),m=s(`<p>最后得到：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>NAME         STATUS     ROLES    AGE    VERSION
...
kubectl get pod,svc
</code></pre></div>`,15);function g(v,f){const n=p("ExternalLinkIcon");return c(),r("div",null,[d,e("p",null,[a("方便测试，具体可根据 "),e("a",i,[a("检查所需端口"),t(n)]),a("。")]),k,e("p",null,[a("如果存在 STATUS 为 Init:ImagePullBackOff，那么可前往 yml 配置文件寻找"),e("a",u,[a("对应的镜像"),t(n)]),a("，手动 "),h,a(" 或 "),b,a("。")]),m])}const x=o(l,[["render",g],["__file","deploy-k8s-with-kubeadm.html.vue"]]);export{x as default};
