import{_ as n,p as s,q as a,a1 as t}from"./framework-49860b1b.js";const p={},e=t(`<h1 id="求平方根" tabindex="-1"><a class="header-anchor" href="#求平方根" aria-hidden="true">#</a> 求平方根</h1><h2 id="二分查找" tabindex="-1"><a class="header-anchor" href="#二分查找" aria-hidden="true">#</a> 二分查找</h2><p>在不允许用原内置数学计算的情况下，可以考虑通过二分法逼近。</p><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">mySqrt</span><span class="token punctuation">(</span>x<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">)</span><span class="token operator">:</span> <span class="token builtin">number</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,4),o=[e];function c(r,l){return s(),a("div",null,o)}const u=n(p,[["render",c],["__file","69-sqrtx.html.vue"]]);export{u as default};
