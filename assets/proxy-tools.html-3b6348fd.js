...
</code></pre></div><h2 id="qv2ray" tabindex="-1"><a class="header-anchor" href="#qv2ray" aria-hidden="true">#</a> Qv2ray</h2><blockquote><p>Qv2ray 在 manjaro 下经常一更新系统就崩，伤透了心</p></blockquote><h2 id="clash" tabindex="-1"><a class="header-anchor" href="#clash" aria-hidden="true">#</a> Clash</h2><h3 id="_1-安装-1" tabindex="-1"><a class="header-anchor" href="#_1-安装-1" aria-hidden="true">#</a> 1. 安装</h3>`,17),d={href:"https://github.com/Dreamacro/clash/releases",target:"_blank",rel:"noopener noreferrer"},u=n(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">cp</span> ~/downloads/clash /usr/local/bin
