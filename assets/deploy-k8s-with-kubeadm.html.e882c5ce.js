import{r as o,c,a,b as t,F as l,e as s,d as e,o as r}from"./app.9e923afa.js";import{_ as p}from"./plugin-vue_export-helper.5a098b48.js";const d={},i=s(`<h2 id="\u524D\u8A00" tabindex="-1"><a class="header-anchor" href="#\u524D\u8A00" aria-hidden="true">#</a> \u524D\u8A00</h2><p>\u867D\u7136 kubeadm \u5C4F\u853D\u4E86\u7EC6\u8282\uFF0C\u9047\u5230\u95EE\u9898\u96BE\u4EE5\u6392\u67E5\uFF0C\u4F46\u662F\u5B83\u7B80\u5355\u5FEB\u6377\u3002</p><p>\u89C4\u5212\u4E3A\u5355 master \u4E09 node \u7684\u96C6\u7FA4\uFF0C\u5E76\u5728 master \u4E2D\u8BBE\u7F6E hosts\u3002</p><div class="language-text ext-text"><pre class="language-text"><code>hostnamectl set-hostname k8s-master
...
</code></pre></div>`,34),m=e("\u5982\u679C\u5B58\u5728 STATUS \u4E3A Init:ImagePullBackOff\uFF0C\u90A3\u4E48\u53EF\u524D\u5F80 yml \u914D\u7F6E\u6587\u4EF6\u5BFB\u627E"),f={href:"https://github.com/coreos/flannel/releases",target:"_blank",rel:"noopener noreferrer"},_=e("\u5BF9\u5E94\u7684\u955C\u50CF"),v=e("\uFF0C\u624B\u52A8 "),x=a("code",null,"docker pull",-1),y=e(" \u6216 "),E=a("code",null,"docker load",-1),O=e("\u3002"),F=s(`<p>\u6700\u540E\u5F97\u5230\uFF1A</p><div class="language-text ext-text"><pre class="language-text"><code>NAME         STATUS     ROLES    AGE    VERSION
...
kubectl get pod,svc
</code></pre></div>`,15);function w(S,N){const n=o("OutboundLink");return r(),c(l,null,[i,a("p",null,[u,a("a",h,[k,t(n)]),b]),g,a("p",null,[m,a("a",f,[_,t(n)]),v,x,y,E,O]),F],64)}var T=p(d,[["render",w]]);export{T as default};
