import{r as o,c as p,a as n,b as e,F as c,d as a,e as t,o as i}from"./app.4a15d415.js";import{_ as l}from"./plugin-vue_export-helper.5a098b48.js";const r={},d=n("h1",{id:"nginx-\u7684\u9650\u5236\u6A21\u5757",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#nginx-\u7684\u9650\u5236\u6A21\u5757","aria-hidden":"true"},"#"),a(" Nginx \u7684\u9650\u5236\u6A21\u5757")],-1),k=n("h2",{id:"\u8BF7\u6C42\u9650\u5236",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#\u8BF7\u6C42\u9650\u5236","aria-hidden":"true"},"#"),a(" \u8BF7\u6C42\u9650\u5236")],-1),u=a("\u8BF7\u6C42\u9650\u5236 "),_={href:"https://nginx.org/en/docs/http/ngx_http_limit_req_module.html",target:"_blank",rel:"noopener noreferrer"},h=a("limit_req_module"),m=a(" \u6BD4\u8FDE\u63A5\u9650\u5236\u66F4\u4F18\u5316\uFF0C\u7531\u4E8E\u4E00\u4E2A\u8FDE\u63A5\u53EF\u4EE5\u88AB\u591A\u6B21\u590D\u7528\u3002"),x=t(`<h3 id="_1-limit-req-zone" tabindex="-1"><a class="header-anchor" href="#_1-limit-req-zone" aria-hidden="true">#</a> 1. limit_req_zone</h3><p>\u9996\u5148\u9700\u8981\u5728 <code>http</code> \u4F5C\u7528\u57DF\u5B9A\u4E49 <code>limit_req_zone</code>\u3002</p><div class="language-nginx ext-nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">Syntax:</span> limit_req_zone key zone=name:size rate=rate [sync]</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre></div><p><code>$binary_remote_addr</code> \u76F8\u5BF9 <code>remote_addr</code> \u5360\u7528\u7684\u7A7A\u95F4\u66F4\u5C11\u3002</p><h2 id="\u8FDE\u63A5\u9650\u5236" tabindex="-1"><a class="header-anchor" href="#\u8FDE\u63A5\u9650\u5236" aria-hidden="true">#</a> \u8FDE\u63A5\u9650\u5236</h2>`,8),v={href:"https://nginx.org/en/docs/http/ngx_http_limit_conn_module.html",target:"_blank",rel:"noopener noreferrer"},g=a("limit_conn_module"),b=a(" \u6B65\u9AA4\u57FA\u672C\u4E0E\u8BF7\u6C42\u9650\u5236\u4E00\u81F4\u3002"),y=t(`<h3 id="_1-limit-conn-zone" tabindex="-1"><a class="header-anchor" href="#_1-limit-conn-zone" aria-hidden="true">#</a> 1. limit_conn_zone</h3><div class="language-nginx ext-nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">Syntax:</span> limit_conn_zone key zone=name:size</span><span class="token punctuation">;</span>
<span class="token directive"><span class="token keyword">Default:</span> \u2014
Context: http
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u8BBF\u95EE-ip-\u9650\u5236" tabindex="-1"><a class="header-anchor" href="#\u8BBF\u95EE-ip-\u9650\u5236" aria-hidden="true">#</a> \u8BBF\u95EE IP \u9650\u5236</h2>`,5),f={href:"https://nginx.org/en/docs/http/ngx_http_access_module.html",target:"_blank",rel:"noopener noreferrer"},w=a("access_module"),z=a(" \u53EF\u7528\u6765\u9650\u5236\u8BBF\u95EE\u7684 IP\uFF0C\u7528\u6CD5\u6BD4\u8F83\u7B80\u5355\u3002"),q=t(`<div class="language-nginx ext-nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">Syntax:</span> allow address | CIDR | unix: | all</span><span class="token punctuation">;</span>
<span class="token directive"><span class="token keyword">Default:</span> \u2014
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u8BBF\u95EE-\u8D26\u53F7-\u9650\u5236" tabindex="-1"><a class="header-anchor" href="#\u8BBF\u95EE-\u8D26\u53F7-\u9650\u5236" aria-hidden="true">#</a> \u8BBF\u95EE \u8D26\u53F7 \u9650\u5236</h2>`,2),C={href:"https://nginx.org/en/docs/http/ngx_http_auth_basic_module.html",target:"_blank",rel:"noopener noreferrer"},D=a("auth_basic_module"),S=a(" \u53EF\u4EE5\u4E3A\u8DEF\u5F84\u6DFB\u52A0\u7528\u6237\u5BC6\u7801\u8BBF\u95EE\uFF0C\u53EF\u914D\u5408 IP \u9650\u5236\u4F7F\u7528\u3002"),$=t(`<h3 id="_1-\u751F\u6210\u5BC6\u7801" tabindex="-1"><a class="header-anchor" href="#_1-\u751F\u6210\u5BC6\u7801" aria-hidden="true">#</a> 1. \u751F\u6210\u5BC6\u7801</h3><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token comment"># \u751F\u6210\u5BC6\u7801\u5DE5\u5177 htpasswd</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,4);function E(I,N){const s=o("OutboundLink");return i(),p(c,null,[d,k,n("p",null,[u,n("a",_,[h,e(s)]),m]),x,n("p",null,[n("a",v,[g,e(s)]),b]),y,n("p",null,[n("a",f,[w,e(s)]),z]),q,n("p",null,[n("a",C,[D,e(s)]),S]),$],64)}var P=l(r,[["render",E]]);export{P as default};
