...
</code></pre></div><div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt</span> <span class="token function">install</span> firmware-b43-installer
</code></pre></div>`,14),u={href:"https://askubuntu.com/questions/765584/is-it-possible-to-use-broadcom-bcm43142-wifi-in-ubuntu-16-04",target:"_blank",rel:"noopener noreferrer"},k=a("\u89E3\u51B3\u65B9\u6848"),b=a("\uFF1A"),h=s(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt-get</span> update
...
</code></pre></div>`,7);function m(f,g){const e=t("OutboundLink");return l(),o(c,null,[d,n("p",null,[n("a",u,[k,p(e)]),b]),h],64)}var w=r(i,[["render",m]]);export{w as default};
