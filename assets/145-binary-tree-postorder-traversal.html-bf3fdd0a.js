...
<span class="token punctuation">}</span>
  ...
  <span class="token keyword">return</span> ret
<span class="token punctuation">}</span>
</code></pre></div>`,6)]))}const l=s(o,[["render",e],["__file","145-binary-tree-postorder-traversal.html.vue"]]);export{l as default};
