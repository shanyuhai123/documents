...
<span class="token punctuation">}</span>
</code></pre></div>`,1);function h(x,f){const p=t("OutboundLink");return l(),o(c,null,[k,s("p",null,[i,s("a",m,[d,e(p)]),g]),b],64)}var w=r(u,[["render",h]]);export{w as default};
