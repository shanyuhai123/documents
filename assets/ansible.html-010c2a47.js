import{_ as c,M as p,p as r,q as i,Q as a,t as s,N as n,V as l,a1 as t}from"./framework-49860b1b.js";const u={},m=a("h1",{id:"分发脚本-ansible",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#分发脚本-ansible","aria-hidden":"true"},"#"),s(" 分发脚本 ansible")],-1),k=a("p",null,"虽然也可以自己写 Shell 实现分发脚本，但由于缺乏运维系统概念，混乱、零碎的写法总是让人难受，一接触到 ansible 就知道很难回去了。",-1),d=t(`<p>需要注意的是 Ansible 需要开启公钥认证，也就是添加到 <code>known_hosts</code> 中，对于大批量的操作可以禁用该行为：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">vim</span> /etc/ansible/ansible.cfg
...
</code></pre></div><h2 id="install" tabindex="-1"><a class="header-anchor" href="#install" aria-hidden="true">#</a> install</h2>`,3),h={href:"https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html#latest-release-via-dnf-or-yum",target:"_blank",rel:"noopener noreferrer"},b=t(`<h3 id="_1-关闭限制" tabindex="-1"><a class="header-anchor" href="#_1-关闭限制" aria-hidden="true">#</a> 1. 关闭限制</h3><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>systemctl stop firewalld
...
</code></pre></div>`,2),y={id:"_2-安装-python",tabindex:"-1"},g=a("a",{class:"header-anchor",href:"#_2-安装-python","aria-hidden":"true"},"#",-1),_={href:"https://www.python.org/downloads/source/",target:"_blank",rel:"noopener noreferrer"},v=t(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> https://www.python.org/ftp/python/3.6.9/Python-3.6.9.tar.xz
...
</code></pre></div><h3 id="_4-安装-ansible" tabindex="-1"><a class="header-anchor" href="#_4-安装-ansible" aria-hidden="true">#</a> 4. 安装 ansible</h3>`,5),f={href:"https://docs.ansible.com/ansible/latest/installation_guide/intro_installation.html#latest-release-via-dnf-or-yum",target:"_blank",rel:"noopener noreferrer"},x=t(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://gitee.com/shanyuhai123/ansible.git
...
</code></pre></div><p>仅列出部分示例。</p>`,14),I={id:"_1-command",tabindex:"-1"},S=a("a",{class:"header-anchor",href:"#_1-command","aria-hidden":"true"},"#",-1),A={href:"https://docs.ansible.com/ansible/latest/modules/command_module.html",target:"_blank",rel:"noopener noreferrer"},M=t(`<p>Execute <strong>command</strong>s on targets。</p><p>实践：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>ansible t1 <span class="token parameter variable">-m</span> <span class="token builtin class-name">command</span> <span class="token parameter variable">-a</span> <span class="token string">&quot;free -m&quot;</span>
...
</code></pre></div>`,3),N={id:"_2-shell",tabindex:"-1"},j=a("a",{class:"header-anchor",href:"#_2-shell","aria-hidden":"true"},"#",-1),E={href:"https://docs.ansible.com/ansible/latest/modules/shell_module.html",target:"_blank",rel:"noopener noreferrer"},V=t(`<p>Execute shell commands on targets。</p><p>实践：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>ansible t1 <span class="token parameter variable">-m</span> shell <span class="token parameter variable">-a</span> <span class="token string">&quot;echo hello &gt; /tmp/tmp.txt&quot;</span>
...
</code></pre></div>`,3),D={id:"_4-script",tabindex:"-1"},F=a("a",{class:"header-anchor",href:"#_4-script","aria-hidden":"true"},"#",-1),H={href:"https://docs.ansible.com/ansible/latest/modules/script_module.html",target:"_blank",rel:"noopener noreferrer"},R=t(`<p>Runs a local script on a remote node after transferring it。</p><p>实践：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token builtin class-name">echo</span> <span class="token string">&quot;echo hello&quot;</span> <span class="token operator">&gt;</span> /tmp/hello.sh
...
</code></pre></div>`,3),z={id:"_5-file",tabindex:"-1"},G=a("a",{class:"header-anchor",href:"#_5-file","aria-hidden":"true"},"#",-1),Q={href:"https://docs.ansible.com/ansible/latest/modules/file_module.html",target:"_blank",rel:"noopener noreferrer"},T=a("p",null,"Manage files and file properties。",-1),U={id:"_6-yum",tabindex:"-1"},W=a("a",{class:"header-anchor",href:"#_6-yum","aria-hidden":"true"},"#",-1),X={href:"https://docs.ansible.com/ansible/latest/modules/yum_module.html",target:"_blank",rel:"noopener noreferrer"},J=t(`<p>Manages packages with the yum package manager。</p><p>实践：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>ansible webservers <span class="token parameter variable">-m</span> <span class="token builtin class-name">command</span> <span class="token parameter variable">-a</span> <span class="token string">&quot;free -m&quot;</span> <span class="token comment"># 验证</span>
...
</code></pre></div>`,3),K={id:"_7-systemd",tabindex:"-1"},O=a("a",{class:"header-anchor",href:"#_7-systemd","aria-hidden":"true"},"#",-1),Z={href:"https://docs.ansible.com/ansible/latest/modules/systemd_module.html",target:"_blank",rel:"noopener noreferrer"},$=t(`<p>Manage services。</p><p>实践：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 最好将服务写完整</span>
...
ansible webservers <span class="token parameter variable">-m</span> <span class="token builtin class-name">command</span> <span class="token parameter variable">-a</span> <span class="token string">&quot;crontab -l&quot;</span> <span class="token comment"># 验证</span>
</code></pre></div><h2 id="playbooks" tabindex="-1"><a class="header-anchor" href="#playbooks" aria-hidden="true">#</a> playbooks</h2><p>相对于 ad-hoc，playbooks 则强大的多，当然也复杂得多。playbook 由一个或多个 plays 组成，在 play 中，一组机器被映射为定义好的角色，其内容被称为 tasks（任务），在基本层次的应用中，一个任务是一个对 ansible 模块的调用。</p>`,5),ta={href:"https://github.com/ansible/ansible-examples",target:"_blank",rel:"noopener noreferrer"},oa=t(`<h3 id="_1-one-play" tabindex="-1"><a class="header-anchor" href="#_1-one-play" aria-hidden="true">#</a> 1. one play</h3><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token punctuation">---</span>
...
roles/
    ...
    monitoring/
    fooapp/
</code></pre></div>`,8);function pa(la,ca){const o=p("RouterLink"),e=p("ExternalLinkIcon");return r(),i("div",null,[m,k,a("p",null,[s("Ansible 是一个用来批量管理部署远程主机上服务的工具，它通过 SSH 协议实现管理节点与远程节点之间的通信，所以首先需要完成 "),n(o,{to:"/os/linux/login-with-rsa-key.html#%E7%94%9F%E6%88%90-rsa"},{default:l(()=>[s("SSH 配置")]),_:1}),s("。")]),d,a("p",null,[s("虽然可以很简单的直接使用 "),a("a",h,[s("yum 安装"),n(e)]),s("，但由于 ansible 是一个 python 编写的工具，这样就会导致 ansible 依赖于全局的 python，当全局依赖发生变化的时候可能导致 ansible 出现冲突或潜在的安全问题，所以需要隔离 ansible 与其他应用。")]),b,a("h3",y,[g,s(" 2. 安装 "),a("a",_,[s("python"),n(e)])]),v,a("p",null,[a("a",f,[s("官网"),n(e)]),s("推荐的安装方式，当下载速度极慢时的"),n(o,{to:"/tools/github/download-huge-project-from-github.html"},{default:l(()=>[s("解决方案")]),_:1}),s("。")]),x,a("p",null,[s("Ansible 可同事操作属于一个组的多台主机，组和主机之间的关系通过 "),a("a",w,[s("inventory"),n(e)]),s(" 文件配置。默认的文件路径为 "),q,s("，除默认文件外，还可以使用多个 inventory 文件，当然也可以从云上拉取配置信息。")]),L,a("h3",I,[S,s(" 1. "),a("a",A,[s("command"),n(e)])]),M,a("h3",N,[j,s(" 2. "),a("a",E,[s("shell"),n(e)])]),V,a("h3",P,[Y,s(" 3. "),a("a",B,[s("copy"),n(e)])]),C,a("h3",D,[F,s(" 4. "),a("a",H,[s("script"),n(e)])]),R,a("h3",z,[G,s(" 5. "),a("a",Q,[s("file"),n(e)])]),T,a("h3",U,[W,s(" 6. "),a("a",X,[s("yum"),n(e)])]),J,a("h3",K,[O,s(" 7. "),a("a",Z,[s("systemd"),n(e)])]),$,a("h3",aa,[sa,s(" 8. "),a("a",na,[s("cron"),n(e)])]),ea,a("p",null,[s("对于如何良好的实践这些内容，有一些整套的 "),a("a",ta,[s("playbooks"),n(e)]),s("。")]),oa])}const ia=c(u,[["render",pa],["__file","ansible.html.vue"]]);export{ia as default};
