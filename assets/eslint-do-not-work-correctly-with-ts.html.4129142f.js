...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,3);function v(j,S){const e=o("OutboundLink");return c(),p(r,null,[u,s("p",null,[d,s("a",k,[h,t(e)]),g]),f,s("p",null,[_,s("a",m,[x,t(e)]),y]),b],64)}var T=i(l,[["render",v]]);export{T as default};
