import{_ as p,M as o,p as c,q as l,Q as n,t as a,N as e,a1 as t}from"./framework-49860b1b.js";const r={},i=n("h1",{id:"arch-系统迁移",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#arch-系统迁移","aria-hidden":"true"},"#"),a(" Arch 系统迁移")],-1),u=n("blockquote",null,[n("p",null,"买了新硬盘，怎么可以吃灰呢？")],-1),d=n("h2",{id:"制作-arch-live",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#制作-arch-live","aria-hidden":"true"},"#"),a(" 制作 Arch Live")],-1),k={href:"https://archlinux.org/download/",target:"_blank",rel:"noopener noreferrer"},h=t(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 用U盘替换 /dev/sdx，如 /dev/sdb。（不要加上数字，也就是说，不要键入 /dev/sdb1 之类的东西)</span>
...
</code></pre></div>`,25),m={href:"https://wiki.archlinux.org/title/Swap_(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)",target:"_blank",rel:"noopener noreferrer"},b=n("code",null,"genfstab",-1),g=t(`<h3 id="_2-安装依赖" tabindex="-1"><a class="header-anchor" href="#_2-安装依赖" aria-hidden="true">#</a> 2. 安装依赖</h3><p>进入系统并安装依赖：</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code>arch-chroot /mnt
...
</code></pre></div>`,8);function v(f,x){const s=o("ExternalLinkIcon");return c(),l("div",null,[i,u,d,n("p",null,[a("首先下载新"),n("a",k,[a("镜像"),e(s)]),a("。")]),h,n("p",null,[a("若后续启用 "),n("a",m,[a("swap"),e(s)]),a("，则再执行 "),b,a(" 即可。")]),g])}const q=p(r,[["render",v],["__file","archlinux-system-migration.html.vue"]]);export{q as default};
