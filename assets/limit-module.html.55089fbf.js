...
<span class="token punctuation">}</span>
</code></pre></div><p><code>$binary_remote_addr</code> \u76F8\u5BF9 <code>remote_addr</code> \u5360\u7528\u7684\u7A7A\u95F4\u66F4\u5C11\u3002</p><h2 id="\u8FDE\u63A5\u9650\u5236" tabindex="-1"><a class="header-anchor" href="#\u8FDE\u63A5\u9650\u5236" aria-hidden="true">#</a> \u8FDE\u63A5\u9650\u5236</h2>`,8),x={href:"https://nginx.org/en/docs/http/ngx_http_limit_conn_module.html",target:"_blank",rel:"noopener noreferrer"},v=a("limit_conn_module"),g=a(" \u6B65\u9AA4\u57FA\u672C\u4E0E\u8BF7\u6C42\u9650\u5236\u4E00\u81F4\u3002"),b=t(`<h3 id="_1-limit-conn-zone" tabindex="-1"><a class="header-anchor" href="#_1-limit-conn-zone" aria-hidden="true">#</a> 1. limit_conn_zone</h3><div class="language-nginx ext-nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">Syntax:</span>	limit_conn_zone key zone=name:size</span><span class="token punctuation">;</span>
<span class="token directive"><span class="token keyword">Default:</span> \u2014
Context: http
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u8BBF\u95EE-ip-\u9650\u5236" tabindex="-1"><a class="header-anchor" href="#\u8BBF\u95EE-ip-\u9650\u5236" aria-hidden="true">#</a> \u8BBF\u95EE IP \u9650\u5236</h2>`,5),y={href:"https://nginx.org/en/docs/http/ngx_http_access_module.html",target:"_blank",rel:"noopener noreferrer"},f=a("access_module"),w=a(" \u53EF\u7528\u6765\u9650\u5236\u8BBF\u95EE\u7684 IP\uFF0C\u7528\u6CD5\u6BD4\u8F83\u7B80\u5355\u3002"),z=t(`<div class="language-nginx ext-nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">Syntax:</span>	allow address | CIDR | unix: | all</span><span class="token punctuation">;</span>
<span class="token directive"><span class="token keyword">Default:</span> \u2014
...
<span class="token punctuation">}</span>
</code></pre></div>`,4);function $(E,I){const s=o("OutboundLink");return i(),p(c,null,[d,n("p",null,[k,n("a",u,[_,e(s)]),h]),m,n("p",null,[n("a",x,[v,e(s)]),g]),b,n("p",null,[n("a",y,[f,e(s)]),w]),z,n("p",null,[n("a",q,[C,e(s)]),D]),S],64)}var B=l(r,[["render",$]]);export{B as default};
