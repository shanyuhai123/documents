...
</code></pre></div><h3 id="git-代理协议的补充" tabindex="-1"><a class="header-anchor" href="#git-代理协议的补充" aria-hidden="true">#</a> Git 代理协议的补充</h3><p>git 代理支持多种协议：http、https、socks、socks5，本机通过 ss 启用了 socks5。</p><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>`,10),g={href:"https://help.github.com/en",target:"_blank",rel:"noopener noreferrer"},m={href:"https://git-scm.com/book/zh/v2",target:"_blank",rel:"noopener noreferrer"},b={href:"https://shafiul.github.io/gitbook/index.html",target:"_blank",rel:"noopener noreferrer"};function f(x,_){const n=o("ExternalLinkIcon");return r(),c("div",null,[h,a("p",null,[a("a",d,[s("Git飞行规则(Flight Rules)"),t(n)]),s(" 可以用来指导一些常见的问题。")]),u,a("ul",null,[a("li",null,[a("a",g,[s("Github"),t(n)])]),a("li",null,[a("a",m,[s("Git-scm"),t(n)])]),a("li",null,[a("a",b,[s("shafiul Community Book"),t(n)])])])])}const y=p(k,[["render",f],["__file","index.html.vue"]]);export{y as default};
