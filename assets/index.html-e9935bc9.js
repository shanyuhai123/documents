import{_ as t,M as r,p as c,q as p,Q as a,t as n,N as e,a1 as o}from"./framework-49860b1b.js";const l={},d=o('<h1 id="人生苦短-我用-docker" tabindex="-1"><a class="header-anchor" href="#人生苦短-我用-docker" aria-hidden="true">#</a> 人生苦短，我用 Docker</h1><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍" aria-hidden="true">#</a> 介绍</h2><p>Docker 利用了 Linux 内核特性命名空间（namespace）及控制组（cgroups）等为容器提供隔离的运行环境，在此基础上可以认为 “容器是一种特殊的进程”。</p><h2 id="使用脚本快速启用-docker" tabindex="-1"><a class="header-anchor" href="#使用脚本快速启用-docker" aria-hidden="true">#</a> 使用脚本快速启用 Docker</h2>',4),i={href:"https://docs.docker.com/engine/install/",target:"_blank",rel:"noopener noreferrer"},u=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-fsSL</span> https://get.docker.com <span class="token parameter variable">-o</span> get-docker.sh
...
</code></pre></div><h3 id="镜像加速" tabindex="-1"><a class="header-anchor" href="#镜像加速" aria-hidden="true">#</a> 镜像加速</h3><p>镜像服务可用：</p>`,10),h={href:"https://cr.console.aliyun.com/cn-hangzhou/instances/mirrors",target:"_blank",rel:"noopener noreferrer"},k={href:"https://www.163yun.com/help/documents/56918246390157312",target:"_blank",rel:"noopener noreferrer"},m=o(`<p>修改本地的 <code>/etc/docker/daemon.json</code> 并修改 <code>registry-mirrors</code>，可为其配置多个避免某个挂掉：</p><div class="language-json" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
</code></pre></div><h3 id="node-js" tabindex="-1"><a class="header-anchor" href="#node-js" aria-hidden="true">#</a> Node.js</h3>`,11),b={href:"https://hub.docker.com/layers/node/library/node/erbium-buster-slim/images/sha256-c6ad96c5345c1a714e0052d08d83635c8e422ea0d103adc7f9f2df4fcfb7fe2d?context=explore",target:"_blank",rel:"noopener noreferrer"},g=o(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 追加 bash，否则会直接进入 node</span>
...
</code></pre></div><h2 id="参考资料" tabindex="-1"><a class="header-anchor" href="#参考资料" aria-hidden="true">#</a> 参考资料</h2>`,16),f={href:"https://docs.docker.com/",target:"_blank",rel:"noopener noreferrer"},v={href:"https://docs.docker.com/engine/reference/commandline/docker/",target:"_blank",rel:"noopener noreferrer"},x=a("li",null,"《Docker 技术入门与实战（第三版）》",-1),_=a("li",null,"《自己动手写 Docker》",-1);function y(D,q){const s=r("ExternalLinkIcon");return c(),p("div",null,[d,a("p",null,[n("在过去常常"),a("a",i,[n("手动安装"),e(s)]),n("，现在已经完全切换为脚本形式了：")]),u,a("ol",null,[a("li",null,[a("a",h,[n("阿里云镜像服务"),e(s)])]),a("li",null,[a("a",k,[n("网易云镜像服务"),e(s)])])]),m,a("p",null,[n("从这里基本就可以了解到这些镜像只是在 Docker Engine 上增加了一些依赖，然后你又基于这些依赖搭建你的环境，可以看看 "),a("a",b,[n("Node Images Layers"),e(s)]),n(" 加深该概念。")]),g,a("ol",null,[a("li",null,[a("a",f,[n("Docker"),e(s)])]),a("li",null,[a("a",v,[n("Docker Commands"),e(s)])]),x,_])])}const S=t(l,[["render",y],["__file","index.html.vue"]]);export{S as default};
