...
</code></pre></div>`,31),k={href:"https://dev.mysql.com/doc/refman/8.0/en/numeric-functions.html",target:"_blank",rel:"noopener noreferrer"},u=a(`<h2 id="计算字段" tabindex="-1"><a class="header-anchor" href="#计算字段" aria-hidden="true">#</a> 计算字段</h2><p>很多时候是由计算返回的结果。别名 <code>alias</code> 可简写为 AS，甚至还可忽略。</p><div class="language-sql" data-ext="sql"><pre class="language-sql"><code><span class="token keyword">SELECT</span> 
  vend_id<span class="token punctuation">,</span>
...
</code></pre></div>`,8);function i(E,_){const e=o("ExternalLinkIcon");return t(),c("div",null,[l,s("p",null,[n("更多内置的方法可"),s("a",k,[n("参考"),d(e)]),n("。")]),u])}const y=p(r,[["render",i],["__file","select.html.vue"]]);export{y as default};
