import{_ as n,p as s,q as a,a1 as t}from"./framework-49860b1b.js";const p={},o=t(`<h1 id="至少是其他数字两倍的最大数" tabindex="-1"><a class="header-anchor" href="#至少是其他数字两倍的最大数" aria-hidden="true">#</a> 至少是其他数字两倍的最大数</h1><p>参考<a href="./414-third-maximum-number">第三大的数</a>。</p><h2 id="遍历" tabindex="-1"><a class="header-anchor" href="#遍历" aria-hidden="true">#</a> 遍历</h2><div class="language-typescript" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">function</span> <span class="token function">dominantIndex</span><span class="token punctuation">(</span>nums<span class="token operator">:</span> <span class="token builtin">number</span><span class="token punctuation">[</span><span class="token punctuation">]</span><span class="token punctuation">)</span><span class="token operator">:</span> <span class="token builtin">number</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>`,4),e=[o];function c(r,l){return s(),a("div",null,e)}const u=n(p,[["render",c],["__file","747-largest-number-at-least-twice-of-others.html.vue"]]);export{u as default};
