import{_ as t,c as p,b as s,d as a,e as o,w as c,a as l,r as i,o as r}from"./app-CVsCLQsN.js";const k={};function d(u,n){const e=i("RouteLink");return r(),p("div",null,[n[3]||(n[3]=s("h1",{id:"websocket-反向代理",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#websocket-反向代理"},[s("span",null,"websocket 反向代理")])],-1)),s("p",null,[n[1]||(n[1]=a("在理解",-1)),o(e,{to:"/backend/nginx/nginx-upstream.html"},{default:c(()=>[...n[0]||(n[0]=[a("反向代理与负载均衡",-1)])]),_:1}),n[2]||(n[2]=a("后就可以快速实现 websocket 的反向代理。",-1))]),n[4]||(n[4]=l(`<h2 id="config" tabindex="-1"><a class="header-anchor" href="#config"><span><a href="http://nginx.org/en/docs/http/websocket.html" target="_blank" rel="noopener noreferrer">config</a></span></a></h2><div class="language-nginx" data-highlighter="prismjs" data-ext="nginx" data-title="nginx"><pre><code><span class="line"><span class="token directive"><span class="token keyword">vim</span> /etc/nginx/conf.d/default.conf</span>
