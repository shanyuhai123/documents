...
</code></pre></div><p>需要注意的是前缀匹配模式下与 <code>location</code> 在文件中的顺序无关，比的是谁的 <code>location</code> 更长；而正则匹配则跟顺序有关。</p>`,12);function h(g,m){const t=o("ExternalLinkIcon");return c(),p("div",null,[i,a("p",null,[n("可以看到 "),a("a",r,[n("location"),l(t)]),n(" 具备两种规则，其中 "),k,n(" 表示内部服务跳转，用于处理异常请求。")]),u])}const y=e(d,[["render",h],["__file","location-rules.html.vue"]]);export{y as default};
