import{_ as s,c as n,a as e,o as p}from"./app-BCSwjUcF.js";const l={};function t(r,a){return p(),n("div",null,a[0]||(a[0]=[e(`<h1 id="使用-harbor-构建私有镜像仓库" tabindex="-1"><a class="header-anchor" href="#使用-harbor-构建私有镜像仓库"><span>使用 Harbor 构建私有镜像仓库</span></a></h1><h2 id="环境" tabindex="-1"><a class="header-anchor" href="#环境"><span>环境</span></a></h2><p>创建一台虚拟机为私有仓库，本机向虚拟机的仓库发起上传和下载。</p><h2 id="搭建仓库" tabindex="-1"><a class="header-anchor" href="#搭建仓库"><span>搭建仓库</span></a></h2><p>在虚拟机上创建仓库，并指定镜像文件存放在本地的默认路径，为其设置 docker 重启后跟随重启。</p><div class="language-bash" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">--restart</span><span class="token operator">=</span>always <span class="token parameter variable">--name</span> registry <span class="token parameter variable">-p</span> <span class="token number">5000</span>:5000 <span class="token parameter variable">-v</span> /opt/data/registry:/var/lib/registry registry</span>
