...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,3);function b(j,S){const e=o("OutboundLink");return c(),p(r,null,[u,s("p",null,[d,s("a",k,[h,t(e)]),f]),g,s("p",null,[_,s("a",m,[x,t(e)]),y]),v],64)}var T=i(l,[["render",b]]);export{T as default};
