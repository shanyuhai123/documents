...
</code></pre></div><h2 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> 参考文章</h2>`,16),u={href:"http://www.ruanyifeng.com/blog/2016/03/systemd-tutorial-commands.html",target:"_blank",rel:"noopener noreferrer"};function k(h,g){const a=o("ExternalLinkIcon");return l(),p("div",null,[r,s("p",null,[n("Unit 配置文件的完整字段清单，请参考"),s("a",d,[n("官方文档"),e(a)]),n("。")]),m,s("p",null,[s("a",u,[n("原文：Systemd 入门教程"),e(a)])])])}const v=c(i,[["render",k],["__file","systemd.html.vue"]]);export{v as default};
