import{r as o,c,a as s,b as a,w as p,F as i,d as n,e,o as r}from"./app.8db4efad.js";import{_ as k}from"./plugin-vue_export-helper.5a098b48.js";const g={},u=s("h2",{id:"\u4ECB\u7ECD",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#\u4ECB\u7ECD","aria-hidden":"true"},"#"),n(" \u4ECB\u7ECD")],-1),d=n("\u5F53\u4F7F\u7528"),h=n("\u7F16\u8BD1\u5B89\u88C5 Nginx"),m=n(" \u540E\uFF0C\u540C\u6837\u5E0C\u671B\u5C06 Nginx \u52A0\u5165\u81F3 systemd \u8FDB\u884C\u7BA1\u7406\uFF0C\u5982\u679C\u53EF\u4EE5\u7684\u8BDD\u5E0C\u671B\u8FDB\u4E00\u6B65\u5BF9\u8BE5 Nginx \u8FDB\u884C\u533A\u5206\u3002"),b=e(`<h2 id="\u9605\u8BFB" tabindex="-1"><a class="header-anchor" href="#\u9605\u8BFB" aria-hidden="true">#</a> \u9605\u8BFB</h2><p>\u9996\u5148\u9700\u8981\u4E86\u89E3\u4E00\u4E0B yum \u5B89\u88C5\u7684 Nginx \u914D\u7F6E\uFF1A</p><div class="language-bash ext-sh"><pre class="language-bash"><code>systemctl <span class="token function">cat</span> nginx.service
...
</code></pre></div>`,3),x=n("\u63A5\u7740\u53EF\u4EE5\u9605\u8BFB\u4E0B\u5B98\u7F51\u7684"),f={href:"https://www.nginx.com/resources/wiki/start/topics/examples/systemd/",target:"_blank",rel:"noopener noreferrer"},v=n("\u793A\u4F8B"),_=n("\uFF1A"),y=e(`<div class="language-bash ext-sh"><pre class="language-bash"><code><span class="token punctuation">[</span>Unit<span class="token punctuation">]</span>
...
</code></pre></div>`,9);function P(S,w){const t=o("RouterLink"),l=o("OutboundLink");return r(),c(i,null,[u,s("p",null,[d,a(t,{to:"/backend/nginx/install-nginx.html#%E7%BC%96%E8%AF%91%E5%AE%89%E8%A3%85"},{default:p(()=>[h]),_:1}),m]),b,s("p",null,[x,s("a",f,[v,a(l)]),_]),y,s("p",null,[E,a(t,{to:"/backend/nginx/install-nginx.html#_2-%E4%B8%8B%E8%BD%BD"},{default:p(()=>[I]),_:1}),N]),D],64)}var B=k(g,[["render",P]]);export{B as default};
