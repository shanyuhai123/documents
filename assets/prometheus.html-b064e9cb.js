import{_ as p,M as o,p as c,q as l,Q as n,t as a,N as e,a1 as t}from"./framework-49860b1b.js";const r={},u=n("h1",{id:"prometheus",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#prometheus","aria-hidden":"true"},"#"),a(" Prometheus")],-1),i=n("h2",{id:"部署",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#部署","aria-hidden":"true"},"#"),a(" 部署")],-1),k={href:"https://prometheus.io/download/",target:"_blank",rel:"noopener noreferrer"},d=t(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 解压</span>
...
<span class="token function">sudo</span> systemctl status prometheus
</code></pre></div>`,1),m={href:"https://hub.docker.com/u/prom",target:"_blank",rel:"noopener noreferrer"},h={href:"https://github.com/cloudalchemy/ansible-prometheus",target:"_blank",rel:"noopener noreferrer"},g=t(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">--restart</span><span class="token operator">=</span>always <span class="token parameter variable">-d</span> <span class="token punctuation">\\</span>
  ...
  prom/prometheus
</code></pre></div><h2 id="配置文件" tabindex="-1"><a class="header-anchor" href="#配置文件" aria-hidden="true">#</a> 配置文件</h2>`,2),_={href:"https://prometheus.io/docs/prometheus/latest/configuration/configuration/",target:"_blank",rel:"noopener noreferrer"},b=n("code",null,"global",-1),y=n("code",null,"alerting",-1),f=n("code",null,"rule_files",-1),v=n("code",null,"scrape_configs",-1),x=t(`<div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># my global config</span>
...
</code></pre></div><h2 id="监控示例" tabindex="-1"><a class="header-anchor" href="#监控示例" aria-hidden="true">#</a> 监控示例</h2><h3 id="_1-node-exporter" tabindex="-1"><a class="header-anchor" href="#_1-node-exporter" aria-hidden="true">#</a> 1. node exporter</h3>`,8),q={href:"https://prometheus.io/download/#node_exporter",target:"_blank",rel:"noopener noreferrer"},w={href:"https://gist.github.com/jarek-przygodzki/735e15337a3502fea40beba27e193b04",target:"_blank",rel:"noopener noreferrer"},j=t(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 创建用户</span>
...
<span class="token function">sudo</span> systemctl status node_exporter
  ...
  google/cadvisor
</code></pre></div><h3 id="_3-日志" tabindex="-1"><a class="header-anchor" href="#_3-日志" aria-hidden="true">#</a> 3. 日志</h3><p>对于没有设置监控或不容易进行监控的遗留应用程序，重写、修补、重构程序以暴露内部状态的成本很高，而使用日志数据作为抓取时间序列数据的来源则更具有可行性。</p>`,8),E={href:"https://github.com/google/mtail/tree/master/examples",target:"_blank",rel:"noopener noreferrer"},P=t(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-dP</span> <span class="token punctuation">\\</span>
...
</code></pre></div><h3 id="_4-黑盒监控" tabindex="-1"><a class="header-anchor" href="#_4-黑盒监控" aria-hidden="true">#</a> 4. 黑盒监控</h3>`,2),S={href:"https://github.com/prometheus/blackbox_exporter",target:"_blank",rel:"noopener noreferrer"},A=t(`<p>先指定要嗅探的配置信息：</p><div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">modules</span><span class="token punctuation">:</span>
...
</code></pre></div><h3 id="_2-基于-api" tabindex="-1"><a class="header-anchor" href="#_2-基于-api" aria-hidden="true">#</a> 2. 基于 API</h3><p>暂不考虑该形式，待后期直接上 k8s。</p><h3 id="_3-基于-dns" tabindex="-1"><a class="header-anchor" href="#_3-基于-dns" aria-hidden="true">#</a> 3. 基于 DNS</h3>`,14),D={href:"https://github.com/jpillora/docker-dnsmasq",target:"_blank",rel:"noopener noreferrer"},N=t(`<div class="language-yaml" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># prometheus 设置</span>
...
dns3.example.com <span class="token number">10.0</span>.0.133
</code></pre></div><h2 id="图形界面" tabindex="-1"><a class="header-anchor" href="#图形界面" aria-hidden="true">#</a> 图形界面</h2>`,4),I={href:"https://hub.docker.com/r/grafana/grafana",target:"_blank",rel:"noopener noreferrer"},z={href:"https://grafana.com/grafana/dashboards?plcmt=footer",target:"_blank",rel:"noopener noreferrer"},B=t(`<div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">--restart</span><span class="token operator">=</span>always <span class="token parameter variable">-d</span> <span class="token punctuation">\\</span>
 ...
 grafana/grafana
</code></pre></div><p>稍后访问 <code>10.0.0.128:3000</code> 并使用 <code>admin/admin</code> 进行登录，在 <code>Configuration</code> 启用 <code>Prometheus</code>，然后就可以在 <code>Dashboards</code> 的 <code>Manage</code> 中查看了。</p><h2 id="警报" tabindex="-1"><a class="header-anchor" href="#警报" aria-hidden="true">#</a> 警报</h2><p>良好的警报应该具备以下特征：</p><ol><li>适当数量的警报，关注症状而不是原因</li><li>应设置正确的警报优先级</li><li>警报应包括适当的上下文，以便它们可以立即使用</li></ol><p>我们会在 Prometheus 服务器上编写警报规则，这些规则将使用收集的指标并在指定的阈值或标准上触发警报，还可以为警报添加一些上下文。当指标达到阈值或标准时，会生成一个警报并将其推送到 Alertmanager。</p>`,6),L={href:"https://awesome-prometheus-alerts.grep.to/",target:"_blank",rel:"noopener noreferrer"},O=t(`<h3 id="alertmanager" tabindex="-1"><a class="header-anchor" href="#alertmanager" aria-hidden="true">#</a> alertmanager</h3><p>Alertmanager 会对警报进行去重、分组，然后路由到不同的接收器，如电子邮件、短信或 SaaS 服务等。</p><div class="language-bash" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">--restart</span><span class="token operator">=</span>always <span class="token parameter variable">-d</span> <span class="token punctuation">\\</span>
 ...
 prom/alertmanager
</code></pre></div><h3 id="配置注意项" tabindex="-1"><a class="header-anchor" href="#配置注意项" aria-hidden="true">#</a> 配置注意项</h3><p>默认 <code>prometheus.yml</code> 中 <code>alertmanager:9093</code> 在 hosts 解析下才会生效，可手动指定 <code>ip:port</code> 解决。</p><p><code>alertmanager.yml</code> 默认情况下所有警报都组合在一起，指定 <code>group_by: [&#39;instance&#39;]</code> 可根据实例组合在一起。</p>`,6),F={href:"https://prometheus.io/docs/alerting/latest/configuration/#route",target:"_blank",rel:"noopener noreferrer"};function T(V,C){const s=o("ExternalLinkIcon");return c(),l("div",null,[u,i,n("p",null,[a("前往"),n("a",k,[a("官网"),e(s)]),a("下载核心：")]),d,n("p",null,[a("使用 "),n("a",m,[a("Docker"),e(s)]),a(" 或 "),n("a",h,[a("Ansible"),e(s)]),a(" 则简单许多：")]),g,n("p",null,[a("默认 "),n("a",_,[a("prometheus.yml"),e(s)]),a(" 定义了 4 个 YAML 块："),b,a("、"),y,a("、"),f,a(" 和 "),v,a("。")]),x,n("p",null,[a("以系统指标 "),n("a",q,[a("node_exporter"),e(s)]),a(" 为示例，可参照 "),n("a",w,[a("node_exporter-as-systemd-service"),e(s)]),a(" 进行配置：")]),j,n("p",null,[a("在 "),n("a",E,[a("examples"),e(s)]),a(" 中提供了日志解析模板。")]),P,n("p",null,[a("可以使用探针监控来查看应用程序的外部状态，"),n("a",S,[a("Blackbox exporter"),e(s)]),a("。")]),A,n("p",null,[a("可配合 "),n("a",D,[a("docker-dnsmasq"),e(s)]),a(" 快速使用。")]),N,n("p",null,[a("可使用 "),n("a",I,[a("grafana"),e(s)]),a(" 完成图形界面，还提供了方便的 "),n("a",z,[a("Dashboards"),e(s)]),a(" 来导入他人的作品。")]),B,n("p",null,[a("可以参考一些报警规则 "),n("a",L,[a("Awesome Prometheus alerts"),e(s)]),a("。")]),O,n("p",null,[a("更多配置可见 "),n("a",F,[a("route"),e(s)]),a("。")])])}const U=p(r,[["render",T],["__file","prometheus.html.vue"]]);export{U as default};
